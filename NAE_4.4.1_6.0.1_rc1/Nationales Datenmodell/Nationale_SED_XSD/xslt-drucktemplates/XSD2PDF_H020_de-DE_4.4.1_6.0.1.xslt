...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
  <xsl:variable name="filename">XSD2PDF_H020_de-DE_4.4.1_6.0.1.xslt</xsl:variable>
        ...
        <fo:static-content flow-name="xsl-region-before">
          <fo:table table-layout="fixed" width="100%" margin="5mm 0mm 0mm 0mm">
            ...
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="14pt" text-align="start">H020 - Erstattungsforderung - Verwaltungskontrolle / medizinische Informationen</fo:block>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="8pt" text-align="start">H020 - Claim for - Reimbursement - Administrative Check /Medical information</fo:block>
                </fo:table-cell>
                <fo:table-cell>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-body start-indent="2mm">
                ...
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">1.3. Gesamtzahl der Rechnungen</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-header background-color="LightGrey">
                            <fo:table-row border="solid 0.2mm Grey">
                              <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                <fo:block>1.4. Gesamtbetrag der Forderung in der Währung des forderungsberechtigten Staates</fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-header>
                          <fo:table-body start-indent="2mm">
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">1.4.1. Betrag</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//GlobalClaim/TotalClaimAmountInCurrencyCreditorInstitution/amount"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">1.4.2. Währung</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//GlobalClaim/TotalClaimAmountInCurrencyCreditorInstitution/currency"/>
                                  <fo:block>
                                    <xsl:choose>
                                      <xsl:when test="//GlobalClaim/TotalClaimAmountInCurrencyCreditorInstitution/currency/value='HRK'">
                                        <fo:block>Kroatische Kuna</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//GlobalClaim/TotalClaimAmountInCurrencyCreditorInstitution/currency/value='CHF'">
                                        <fo:block>Schweizer Franken</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//GlobalClaim/TotalClaimAmountInCurrencyCreditorInstitution/currency/value='ISK'">
                                        <fo:block>Isländische Krone</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//GlobalClaim/TotalClaimAmountInCurrencyCreditorInstitution/currency/value='EUR'">
                                        <fo:block>Euro</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//GlobalClaim/TotalClaimAmountInCurrencyCreditorInstitution/currency/value='LVL'">
                                        <fo:block>lettische Lats</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//GlobalClaim/TotalClaimAmountInCurrencyCreditorInstitution/currency/value='DKK'">
                                        <fo:block>Dänische Krone</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//GlobalClaim/TotalClaimAmountInCurrencyCreditorInstitution/currency/value='LTL'">
                                        <fo:block>litauische Litas</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//GlobalClaim/TotalClaimAmountInCurrencyCreditorInstitution/currency/value='BGN'">
                                        <fo:block>Bulgarischer Lew</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//GlobalClaim/TotalClaimAmountInCurrencyCreditorInstitution/currency/value='NOK'">
                                        <fo:block>Norwegische Krone</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//GlobalClaim/TotalClaimAmountInCurrencyCreditorInstitution/currency/value='RON'">
                                        <fo:block>Rumänischer Leu</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//GlobalClaim/TotalClaimAmountInCurrencyCreditorInstitution/currency/value='PLN'">
                                        <fo:block>Polnischer Zloty</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//GlobalClaim/TotalClaimAmountInCurrencyCreditorInstitution/currency/value='GBP'">
                                        <fo:block>Britisches Pfund</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//GlobalClaim/TotalClaimAmountInCurrencyCreditorInstitution/currency/value='CZK'">
                                        <fo:block>Tschechische Krone</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//GlobalClaim/TotalClaimAmountInCurrencyCreditorInstitution/currency/value='HUF'">
                                        <fo:block>Ungarischer Forint</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//GlobalClaim/TotalClaimAmountInCurrencyCreditorInstitution/currency/value='SEK'">
                            ...
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">1.4.3. Zahlung fällig am</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//GlobalClaim/TotalClaimAmountInCurrencyCreditorInstitution/paymentDueOn"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-body>
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-header background-color="LightGrey">
                            <fo:table-row border="solid 0.2mm Grey">
                              <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                <fo:block>1.5. Leistungspflichtiger Träger</fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-header>
                          <fo:table-body start-indent="2mm">
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">1.5.1. Träger-ID</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//GlobalClaim/DebtorInstitution/institutionID"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">1.5.2. Name des Trägers</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//GlobalClaim/DebtorInstitution/institutionName"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-body>
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-header background-color="LightGrey">
                            <fo:table-row border="solid 0.2mm Grey">
                              <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                <fo:block>1.6. Bankverbindung</fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-header>
                          <fo:table-body start-indent="2mm">
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">1.6.1. IBAN</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//GlobalClaim/BankDetails/IBAN"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">1.6.2. BIC-SWIFT</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//GlobalClaim/BankDetails/BICSWIFT"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-body>
                              ...
                              <fo:table-row>
                                <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                  <fo:block wrap-option="wrap">2.2.1.[
                                    <xsl:value-of select="position()"/>] In Bezug auf Ihr(e/en)
                                  </fo:block>
                                </fo:table-cell>
                                <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                  <fo:block>
                                    <xsl:value-of select="inReferenceYour"/>
                                    <fo:block>
                                      <xsl:choose>
                                        <xsl:when test="inReferenceYour/value='01'">
                                          <fo:block>Ersuchen um verwaltungsmäßige Kontrolle</fo:block>
                                        </xsl:when>
                                        <xsl:when test="inReferenceYour/value='02'">
