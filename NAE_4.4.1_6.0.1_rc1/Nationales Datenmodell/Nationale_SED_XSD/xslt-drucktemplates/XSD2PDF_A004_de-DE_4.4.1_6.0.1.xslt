...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
  <xsl:variable name="filename">XSD2PDF_A004_de-DE_4.4.1_6.0.1.xslt</xsl:variable>
    ...
    <fo:root font-family="Arial Unicode MS" font-size="10pt">
      ...
      <fo:page-sequence master-reference="Standard">
        <fo:static-content flow-name="xsl-region-before">
          <fo:table table-layout="fixed" width="100%" margin="5mm 0mm 0mm 0mm">
            ...
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="14pt" text-align="start">A004 - Zurückweisung der Festlegung der anwendbaren Rechtsvorschriften</fo:block>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="8pt" text-align="start">A004 - Rejection of Determination on Applicable Legislation</fo:block>
                </fo:table-cell>
                <fo:table-cell>
        ...
        <fo:flow flow-name="xsl-region-body">
          <fo:block font-family="Arial Unicode MS" font-size="10pt">Artikel 13 Absätze 1, 2, 3 und 4 der Verordnung (EG) Nr. 883/2004 und Artikel 14 Absatz 5 Buchstabe b, Artikel 14 Absatz 11 und Artikel 16 der Verordnung (EG) Nr. 987/2009</fo:block>
          <fo:block>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>4. Zurückweisung der Festlegung</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">4.1. Begründung</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//RejectionDetermination/justification"/>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">4.2. Ersuchen um weitere Informationen folgt</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//RejectionDetermination/requestForMoreInformationWillSentIndicator"/>
                      <fo:block>
                        <xsl:choose>
                          <xsl:when test="//RejectionDetermination/requestForMoreInformationWillSentIndicator/value='0'">
                            <fo:block>Nein</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/requestForMoreInformationWillSentIndicator/value='1'">
                ...
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">4.3. Neuer Vorschlag zum Staat, dessen Rechtsvorschriften anzuwenden sind</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation"/>
                      <fo:block>
                        <xsl:choose>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='DE'">
                            <fo:block>Deutschland</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='NO'">
                            <fo:block>Norwegen</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='BE'">
                            <fo:block>Belgien</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='FI'">
                            <fo:block>Finnland</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='PT'">
                            <fo:block>Portugal</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='BG'">
                            <fo:block>Bulgarien</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='DK'">
                            <fo:block>Dänemark</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='LT'">
                            <fo:block>Litauen</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='LU'">
                            <fo:block>Luxemburg</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='HR'">
                            <fo:block>Kroatien</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='LV'">
                            <fo:block>Lettland</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='FR'">
                            <fo:block>Frankreich</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='HU'">
                            <fo:block>Ungarn</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='SE'">
                            <fo:block>Schweden</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='SI'">
                            <fo:block>Slowenien</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='UK'">
                            <fo:block>Vereinigtes Königreich</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='SK'">
                            <fo:block>Slowakei</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='IE'">
                            <fo:block>Irland</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='EE'">
                            <fo:block>Estland</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='CH'">
                            <fo:block>Schweiz</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='EL'">
                            <fo:block>Griechenland</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='MT'">
                            <fo:block>Malta</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='IS'">
                            <fo:block>Island</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='IT'">
                            <fo:block>Italien</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='ES'">
                            <fo:block>Spanien</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='AT'">
                            <fo:block>Österreich</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='CY'">
                            <fo:block>Zypern</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='CZ'">
                            <fo:block>Tschechien</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='PL'">
                            <fo:block>Polen</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='LI'">
                            <fo:block>Liechtenstein</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='RO'">
                            <fo:block>Rumänien</fo:block>
                          </xsl:when>
                          <xsl:when test="//RejectionDetermination/newProposalRegardingCountryApplicableLegislation/value='NL'">
                            <fo:block>Niederlande</fo:block>
                          </xsl:when>
                          <xsl:otherwise>
                            <fo:block>-/-</fo:block>
