...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
  <xsl:variable name="filename">XSD2PDF_S045_en-UK_4.4.1_6.0.1.xslt</xsl:variable>
    ...
    <fo:root font-family="Arial Unicode MS" font-size="10pt">
      ...
      <fo:page-sequence master-reference="Standard">
        <fo:static-content flow-name="xsl-region-before">
          <fo:table table-layout="fixed" width="100%" margin="5mm 0mm 0mm 0mm">
            ...
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="14pt" text-align="start">S045 - Entitlement Document - Temporary Stay</fo:block>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="8pt" text-align="start">S045 - Entitlement Document - Temporary Stay</fo:block>
                </fo:table-cell>
                <fo:table-cell>
        ...
        <fo:flow flow-name="xsl-region-body">
          <fo:block font-family="Arial Unicode MS" font-size="10pt">Articles 19, 27(1) of Regulation (EC) No 883/2004; Article 25 of Regulation (EC) No 987/2009</fo:block>
          <fo:block>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>2. Address (of the person for whom an entitlement document is issued)</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                <fo:table-row>
                  ...
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//AddressOfPersonForWhomAnEntitlementDocumentIssued/street"/>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                  ...
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//AddressOfPersonForWhomAnEntitlementDocumentIssued/buildingName"/>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                  ...
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//AddressOfPersonForWhomAnEntitlementDocumentIssued/town"/>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                  ...
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//AddressOfPersonForWhomAnEntitlementDocumentIssued/postalCode"/>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                  ...
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//AddressOfPersonForWhomAnEntitlementDocumentIssued/region"/>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                  ...
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country"/>
                      <fo:block>
                        <xsl:choose>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='PR'">
                            <fo:block>Puerto Rico</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='PS'">
                            <fo:block>Palestine, State of</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='PT'">
                            <fo:block>Portugal</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='PW'">
                            <fo:block>Palau</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='PY'">
                            <fo:block>Paraguay</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='QA'">
                            <fo:block>Qatar</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='AD'">
                            <fo:block>Andorra</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='AE'">
                            <fo:block>United Arab Emirates (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='AF'">
                            <fo:block>Afghanistan</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='AG'">
                            <fo:block>Antigua and Barbuda</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='AI'">
                            <fo:block>Anguilla</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='AL'">
                            <fo:block>Albania</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='AM'">
                            <fo:block>Armenia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='AO'">
                            <fo:block>Angola</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='AQ'">
                            <fo:block>Antarctica</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='AR'">
                            <fo:block>Argentina</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='AS'">
                            <fo:block>American Samoa</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='AT'">
                            <fo:block>Austria</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='RE'">
                            <fo:block>Réunion</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='AU'">
                            <fo:block>Australia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='AW'">
                            <fo:block>Aruba</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='AX'">
                            <fo:block>Aland Islands</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='AZ'">
                            <fo:block>Azerbaijan</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='RO'">
                            <fo:block>Romania</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BA'">
                            <fo:block>Bosnia and Herzegovina</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BB'">
                            <fo:block>Barbados</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='RS'">
                            <fo:block>Serbia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BD'">
                            <fo:block>Bangladesh</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BE'">
                            <fo:block>Belgium</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='RU'">
                            <fo:block>Russian Federation (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BF'">
                            <fo:block>Burkina Faso</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BG'">
                            <fo:block>Bulgaria</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='RW'">
                            <fo:block>Rwanda</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BH'">
                            <fo:block>Bahrain</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BI'">
                            <fo:block>Burundi</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BJ'">
                            <fo:block>Benin</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BL'">
                            <fo:block>Saint Barthélemy</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BM'">
                            <fo:block>Bermuda</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BN'">
                            <fo:block>Brunei Darussalam</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BO'">
                            <fo:block>Bolivia (Plurinational State of)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='SA'">
                            <fo:block>Saudi Arabia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BQ'">
                            <fo:block>Bonaire, Sint Eustatius and Saba</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='SB'">
                            <fo:block>Solomon Islands</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BR'">
                            <fo:block>Brazil</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='SC'">
                            <fo:block>Seychelles</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BS'">
                            <fo:block>Bahamas (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='SD'">
                            <fo:block>Sudan (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='SE'">
                            <fo:block>Sweden</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BT'">
                            <fo:block>Bhutan</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BV'">
                            <fo:block>Bouvet Island</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='SG'">
                            <fo:block>Singapore</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BW'">
                            <fo:block>Botswana</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='SH'">
                            <fo:block>Saint Helena, Ascension and Tristan da Cunha</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='SI'">
                            <fo:block>Slovenia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BY'">
                            <fo:block>Belarus</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='SJ'">
                            <fo:block>Svalbard and Jan Mayen</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='SK'">
                            <fo:block>Slovakia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='BZ'">
                            <fo:block>Belize</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='SL'">
                            <fo:block>Sierra Leone</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='SM'">
                            <fo:block>San Marino</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='SN'">
                            <fo:block>Senegal</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='SO'">
                            <fo:block>Somalia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='CA'">
                            <fo:block>Canada</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='SR'">
                            <fo:block>Suriname</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='CC'">
                            <fo:block>Cocos (Keeling) Islands (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='SS'">
                            <fo:block>South Sudan</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='CD'">
                            <fo:block>Congo, the Democratic Republic of the</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='ST'">
                            <fo:block>Sao Tome and Principe</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='CF'">
                            <fo:block>Central African Republic (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='SV'">
                            <fo:block>El Salvador</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='CG'">
                            <fo:block>Congo</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='CH'">
                            <fo:block>Switzerland</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='SX'">
                            <fo:block>Sint Maarten (Dutch part)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='CI'">
                            <fo:block>Cote d'Ivoire</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='SY'">
                            <fo:block>Syrian Arab Republic</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='SZ'">
                            <fo:block>Swaziland</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='CK'">
                            <fo:block>Cook Islands (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='CL'">
                            <fo:block>Chile</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='CM'">
                            <fo:block>Cameroon</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='CN'">
                            <fo:block>China</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='CO'">
                            <fo:block>Colombia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='CR'">
                            <fo:block>Costa Rica</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='TC'">
                            <fo:block>Turks and Caicos Islands (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='TD'">
                            <fo:block>Chad</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='CU'">
                            <fo:block>Cuba</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='TF'">
                            <fo:block>French Southern Territories (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='CV'">
                            <fo:block>Cabo Verde</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='TG'">
                            <fo:block>Togo</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='CW'">
                            <fo:block>Curaçao</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='TH'">
                            <fo:block>Thailand</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='CX'">
                            <fo:block>Christmas Island</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='CY'">
                            <fo:block>Cyprus</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='TJ'">
                            <fo:block>Tajikistan</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='CZ'">
                            <fo:block>Czechia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='TK'">
                            <fo:block>Tokelau</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='TL'">
                            <fo:block>Timor-Leste</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='TM'">
                            <fo:block>Turkmenistan</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='TN'">
                            <fo:block>Tunisia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='TO'">
                            <fo:block>Tonga</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='TR'">
                            <fo:block>Turkey</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='TT'">
                            <fo:block>Trinidad and Tobago</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='DE'">
                            <fo:block>Germany</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='TV'">
                            <fo:block>Tuvalu</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='TW'">
                            <fo:block>Taiwan (Province of China)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='DJ'">
                            <fo:block>Djibouti</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='TZ'">
                            <fo:block>Tanzania, United Republic of</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='DK'">
                            <fo:block>Denmark</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='DM'">
                            <fo:block>Dominica</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='DO'">
                            <fo:block>Dominican Republic (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='UA'">
                            <fo:block>Ukraine</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='UG'">
                            <fo:block>Uganda</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='UK'">
                            <fo:block>United Kingdom</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='DZ'">
                            <fo:block>Algeria</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='UM'">
                            <fo:block>United States Minor Outlying Islands (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='EC'">
                            <fo:block>Ecuador</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='US'">
                            <fo:block>United States of America (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='EE'">
                            <fo:block>Estonia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='EG'">
                            <fo:block>Egypt</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='EH'">
                            <fo:block>Western Sahara</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='UY'">
                            <fo:block>Uruguay</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='UZ'">
                            <fo:block>Uzbekistan</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='EL'">
                            <fo:block>Greece</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='VA'">
                            <fo:block>Holy See (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='ER'">
                            <fo:block>Eritrea</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='VC'">
                            <fo:block>Saint Vincent and the Grenadines</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='ES'">
                            <fo:block>Spain</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='ET'">
                            <fo:block>Ethiopia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='VE'">
                            <fo:block>Venezuela (Bolivarian Republic of)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='VG'">
                            <fo:block>Virgin Islands (British)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='VI'">
                            <fo:block>Virgin Islands (U.S.)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='VN'">
                            <fo:block>Viet Nam</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='VU'">
                            <fo:block>Vanuatu</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='FI'">
                            <fo:block>Finland</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='FJ'">
                            <fo:block>Fiji</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='FK'">
                            <fo:block>Falkland Islands (the) [Malvinas]</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='FM'">
                            <fo:block>Micronesia (Federated States of)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='FO'">
                            <fo:block>Faroe Islands (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='FR'">
                            <fo:block>France</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='WF'">
                            <fo:block>Wallis and Futuna</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='GA'">
                            <fo:block>Gabon</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='WS'">
                            <fo:block>Samoa</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='GD'">
                            <fo:block>Grenada</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='GE'">
                            <fo:block>Georgia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='GF'">
                            <fo:block>French Guiana</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='GG'">
                            <fo:block>Guernsey</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='GH'">
                            <fo:block>Ghana</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='GI'">
                            <fo:block>Gibraltar</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='GL'">
                            <fo:block>Greenland</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='GM'">
                            <fo:block>Gambia (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='GN'">
                            <fo:block>Guinea</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='GP'">
                            <fo:block>Guadeloupe</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='GQ'">
                            <fo:block>Equatorial Guinea</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='GS'">
                            <fo:block>South Georgia and the South Sandwich Islands</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='GT'">
                            <fo:block>Guatemala</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='GU'">
                            <fo:block>Guam</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='GW'">
                            <fo:block>Guinea-Bissau</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='GY'">
                            <fo:block>Guyana</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='XK'">
                            <fo:block>Kosovo</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='HK'">
                            <fo:block>Hong Kong</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='HM'">
                            <fo:block>Heard Island and McDonald Islands</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='HN'">
                            <fo:block>Honduras</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='HR'">
                            <fo:block>Croatia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='HT'">
                            <fo:block>Haiti</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='YE'">
                            <fo:block>Yemen</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='HU'">
                            <fo:block>Hungary</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='ID'">
                            <fo:block>Indonesia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='YT'">
                            <fo:block>Mayotte</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='IE'">
                            <fo:block>Ireland</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='IL'">
                            <fo:block>Israel</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='IM'">
                            <fo:block>Isle of Man</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='IN'">
                            <fo:block>India</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='IO'">
                            <fo:block>British Indian Ocean Territory (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='ZA'">
                            <fo:block>South Africa</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='IQ'">
                            <fo:block>Iraq</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='IR'">
                            <fo:block>Iran (Islamic Republic of)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='IS'">
                            <fo:block>Iceland</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='IT'">
                            <fo:block>Italy</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='ZM'">
                            <fo:block>Zambia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='JE'">
                            <fo:block>Jersey</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='ZW'">
                            <fo:block>Zimbabwe</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='JM'">
                            <fo:block>Jamaica</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='JO'">
                            <fo:block>Jordan</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='JP'">
                            <fo:block>Japan</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='KE'">
                            <fo:block>Kenya</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='KG'">
                            <fo:block>Kyrgyzstan</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='KH'">
                            <fo:block>Cambodia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='KI'">
                            <fo:block>Kiribati</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='KM'">
                            <fo:block>Comoros</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='KN'">
                            <fo:block>Saint Kitts and Nevis</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='KP'">
                            <fo:block>Korea (the Democratic People's Republic of)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='KR'">
                            <fo:block>Korea (the Republic of)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='KW'">
                            <fo:block>Kuwait</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='KY'">
                            <fo:block>Cayman Islands (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='KZ'">
                            <fo:block>Kazakhstan</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='LA'">
                            <fo:block>Lao People's Democratic Republic (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='LB'">
                            <fo:block>Lebanon</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='LC'">
                            <fo:block>Saint Lucia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='LI'">
                            <fo:block>Liechtenstein</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='LK'">
                            <fo:block>Sri Lanka</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='LR'">
                            <fo:block>Liberia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='LS'">
                            <fo:block>Lesotho</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='LT'">
                            <fo:block>Lithuania</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='LU'">
                            <fo:block>Luxembourg</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='LV'">
                            <fo:block>Latvia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='LY'">
                            <fo:block>Libya</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MA'">
                            <fo:block>Morocco</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MC'">
                            <fo:block>Monaco</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MD'">
                            <fo:block>Moldova (the Republic of)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='ME'">
                            <fo:block>Montenegro</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MF'">
                            <fo:block>Saint Martin (French part)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MG'">
                            <fo:block>Madagascar</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MH'">
                            <fo:block>Marshall Islands (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MK'">
                            <fo:block>Macedonia (the former Yugoslav Republic of)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='ML'">
                            <fo:block>Mali</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MM'">
                            <fo:block>Myanmar</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MN'">
                            <fo:block>Mongolia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MO'">
                            <fo:block>Macao</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MP'">
                            <fo:block>Northern Mariana Islands (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MQ'">
                            <fo:block>Martinique</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MR'">
                            <fo:block>Mauritania</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MS'">
                            <fo:block>Montserrat</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MT'">
                            <fo:block>Malta</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MU'">
                            <fo:block>Mauritius</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MV'">
                            <fo:block>Maldives</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MW'">
                            <fo:block>Malawi</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MX'">
                            <fo:block>Mexico</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MY'">
                            <fo:block>Malaysia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='MZ'">
                            <fo:block>Mozambique</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='NA'">
                            <fo:block>Namibia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='NC'">
                            <fo:block>New Caledonia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='NE'">
                            <fo:block>Niger (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='NF'">
                            <fo:block>Norfolk Island</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='NG'">
                            <fo:block>Nigeria</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='NI'">
                            <fo:block>Nicaragua</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='NL'">
                            <fo:block>Netherlands (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='NO'">
                            <fo:block>Norway</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='NP'">
                            <fo:block>Nepal</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='NR'">
                            <fo:block>Nauru</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='NU'">
                            <fo:block>Niue</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='NZ'">
                            <fo:block>New Zealand</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='OM'">
                            <fo:block>Oman</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='PA'">
                            <fo:block>Panama</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='PE'">
                            <fo:block>Peru</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='PF'">
                            <fo:block>French Polynesia</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='PG'">
                            <fo:block>Papua New Guinea</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='PH'">
                            <fo:block>Philippines (the)</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='PK'">
                            <fo:block>Pakistan</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='PL'">
                            <fo:block>Poland</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='PM'">
                            <fo:block>Saint Pierre and Miquelon</fo:block>
                          </xsl:when>
                          <xsl:when test="//AddressOfPersonForWhomAnEntitlementDocumentIssued/country/value='PN'">
                            <fo:block>Pitcairn</fo:block>
                          </xsl:when>
                          <xsl:otherwise>
                            <fo:block>-/-</fo:block>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>3. Info on entitlement</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-header background-color="LightGrey">
                            <fo:table-row border="solid 0.2mm Grey">
                              <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                <fo:block>3.1. Period of entitlement</fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-header>
                          <fo:table-body start-indent="2mm">
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//InfoEntitlement/PeriodEntitlement/startDate"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//InfoEntitlement/PeriodEntitlement/endDate"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-body>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>4. Info on non-entitlement</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">4.1. Info on non-entitlement</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//InfoNonEntitlement/infoNonEntitlement"/>
                      <fo:block>
                        <xsl:choose>
                          <xsl:when test="//InfoNonEntitlement/infoNonEntitlement/value='99'">
                            <fo:block>Other reason</fo:block>
                          </xsl:when>
                          <xsl:when test="//InfoNonEntitlement/infoNonEntitlement/value='01'">
                            <fo:block>Not entitled to sickness benefits from this member state during the requested period</fo:block>
                          </xsl:when>
                          <xsl:when test="//InfoNonEntitlement/infoNonEntitlement/value='98'">
                            <fo:block>Unknown in this situation</fo:block>
                          </xsl:when>
                          <xsl:otherwise>
                            <fo:block>-/-</fo:block>
                          </xsl:otherwise>
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-header background-color="LightGrey">
                            <fo:table-row border="solid 0.2mm Grey">
                              <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                <fo:block>4.2. Please fill in the following if \Info on non-entitlement\ = \Other reason\ :</fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-header>
                          <fo:table-body start-indent="2mm">
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">4.2.1. Reason</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//InfoNonEntitlement/FillInIfInfoNonEntitlementOther/reason"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-body>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>5. EHIC - European Health Insurance Card</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">5.1. EHIC Number</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//EHICEuropeanHealthInsuranceCard/eHICNumber"/>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-body>
