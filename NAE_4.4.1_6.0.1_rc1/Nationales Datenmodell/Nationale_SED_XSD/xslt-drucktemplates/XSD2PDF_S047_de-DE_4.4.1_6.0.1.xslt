...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
  <xsl:variable name="filename">XSD2PDF_S047_de-DE_4.4.1_6.0.1.xslt</xsl:variable>
    ...
    <fo:root font-family="Arial Unicode MS" font-size="10pt">
      ...
      <fo:page-sequence master-reference="Standard">
        <fo:static-content flow-name="xsl-region-before">
          <fo:table table-layout="fixed" width="100%" margin="5mm 0mm 0mm 0mm">
            ...
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="14pt" text-align="start">S047 - Informationen zu Geldleistungen bei Arbeitsunfähigkeit oder sonstige wesentliche Angaben - mitgeteilt durch den zuständigen Träger</fo:block>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="8pt" text-align="start">S047 - Information Related to Cash Benefits in Respect of Incapacity for Work or other crucial information - given by competent institution</fo:block>
                </fo:table-cell>
                <fo:table-cell>
        ...
        <fo:flow flow-name="xsl-region-body">
          <fo:block font-family="Arial Unicode MS" font-size="10pt">Artikel 21 der Verordnung (EG) Nr. 883/2004; Artikel 2 Absatz 2 der Verordnung (EG) Nr. 987/2009</fo:block>
          <fo:block>
                    ...
                    <fo:block>
                      ...
                      <fo:block>
                        <xsl:for-each select="//WeInformAbout/typeInformation/value">
                          <xsl:choose>
                            <xsl:when test=".='01'">
                              <fo:block>Der letzte Tag des Bezugs von Geldleistungen bei Arbeitsunfähigkeit durch die betreffende Person</fo:block>
                            </xsl:when>
                            <xsl:when test=".='02'">
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-header background-color="LightGrey">
                            <fo:table-row border="solid 0.2mm Grey">
                              <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                <fo:block>3.2. Füllen Sie bitte folgendes Feld aus, wenn „Art der Angaben“ = „01 - Der letzte Tag des Bezugs von Geldleistungen bei Arbeitsunfähigkeit durch die betreffende Person“:</fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-header>
                          <fo:table-body start-indent="2mm">
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">3.2.1. Der letzte Tag des Bezugs von Geldleistungen bei Arbeitsunfähigkeit durch die betreffende Person</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//WeInformAbout/FillInIfTypeInformationTheLastDay/lastDayPersonReceivesCashBenefitsForWorkIncapacity"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-body>
                        ...
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-body start-indent="2mm">
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//WeInformAbout/FillInIfTypeInformationOther/otherCrucialInformationOrAnyAdditionalInformation"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-body>
