...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
  <xsl:variable name="filename">XSD2PDF_S005_de-DE_4.4.1_6.0.1.xslt</xsl:variable>
    ...
    <fo:root font-family="Arial Unicode MS" font-size="10pt">
      ...
      <fo:page-sequence master-reference="Standard">
        <fo:static-content flow-name="xsl-region-before">
          <fo:table table-layout="fixed" width="100%" margin="5mm 0mm 0mm 0mm">
            ...
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="14pt" text-align="start">S005 - Information über Änderung des Anspruchs auf Sachleistungen - Pflege</fo:block>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="8pt" text-align="start">S005 - Information on Change of Entitlement to Benefits in Kind - Long term care</fo:block>
                </fo:table-cell>
                <fo:table-cell>
        ...
        <fo:flow flow-name="xsl-region-body">
          <fo:block font-family="Arial Unicode MS" font-size="10pt">Artikel 34 der Verordnung (EG) Nr. 883/2004; Artikel 31 der Verordnung (EG) Nr. 978/2009</fo:block>
          <fo:block>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>3. Änderung des Anspruchs auf Sachleistungen - Pflege</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-header background-color="LightGrey">
                            <fo:table-row border="solid 0.2mm Grey">
                              <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                <fo:block>3.1. Zeitraum</fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-header>
                          <fo:table-body start-indent="2mm">
                                  ...
                                  <fo:block>
                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                      ...
                                      <fo:table-header background-color="LightGrey">
                                        <fo:table-row border="solid 0.2mm Grey">
                                          <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>3.1.1. Feststehender Zeitraum</fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-header>
                                      <fo:table-body start-indent="2mm">
                                        <fo:table-row>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block wrap-option="wrap">3.1.1.1. Datum Beginn</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//ChangeEntitlementBenefitsInKindLongTermCare/Period/FixedPeriod/startDate"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                        <fo:table-row>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block wrap-option="wrap">3.1.1.2. Datum Ende</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//ChangeEntitlementBenefitsInKindLongTermCare/Period/FixedPeriod/endDate"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-body>
                                  ...
                                  <fo:block>
                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                      ...
                                      <fo:table-header background-color="LightGrey">
                                        <fo:table-row border="solid 0.2mm Grey">
                                          <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>3.1.2. Offener Zeitraum</fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-header>
                                      <fo:table-body start-indent="2mm">
                                        <fo:table-row>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block wrap-option="wrap">3.1.2.1. Art des offenen Zeitraums</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//ChangeEntitlementBenefitsInKindLongTermCare/Period/OpenPeriod/typeOpenPeriod"/>
                                              <fo:block>
                                                <xsl:choose>
                                                  <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/Period/OpenPeriod/typeOpenPeriod/value='01'">
                                                    <fo:block>Unbefristeter Zeitraum</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/Period/OpenPeriod/typeOpenPeriod/value='98'">
                                        ...
                                        <fo:table-row>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block wrap-option="wrap">3.1.2.2. Datum Beginn</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//ChangeEntitlementBenefitsInKindLongTermCare/Period/OpenPeriod/startDate"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-body>
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-body start-indent="2mm">
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">3.2.1. Betrag</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//ChangeEntitlementBenefitsInKindLongTermCare/Amount/amount"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">3.2.2. Währung</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//ChangeEntitlementBenefitsInKindLongTermCare/Amount/currency"/>
                                  <fo:block>
                                    <xsl:choose>
                                      <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/Amount/currency/value='HRK'">
                                        <fo:block>Kroatische Kuna</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/Amount/currency/value='CHF'">
                                        <fo:block>Schweizer Franken</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/Amount/currency/value='ISK'">
                                        <fo:block>Isländische Krone</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/Amount/currency/value='EUR'">
                                        <fo:block>Euro</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/Amount/currency/value='LVL'">
                                        <fo:block>lettische Lats</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/Amount/currency/value='DKK'">
                                        <fo:block>Dänische Krone</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/Amount/currency/value='LTL'">
                                        <fo:block>litauische Litas</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/Amount/currency/value='BGN'">
                                        <fo:block>Bulgarischer Lew</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/Amount/currency/value='NOK'">
                                        <fo:block>Norwegische Krone</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/Amount/currency/value='RON'">
                                        <fo:block>Rumänischer Leu</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/Amount/currency/value='PLN'">
                                        <fo:block>Polnischer Zloty</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/Amount/currency/value='GBP'">
                                        <fo:block>Britisches Pfund</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/Amount/currency/value='CZK'">
                                        <fo:block>Tschechische Krone</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/Amount/currency/value='HUF'">
                                        <fo:block>Ungarischer Forint</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/Amount/currency/value='SEK'">
                ...
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">3.3. Zahlungsrhythmus</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//ChangeEntitlementBenefitsInKindLongTermCare/frequencyPayment"/>
                      <fo:block>
                        <xsl:choose>
                          <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/frequencyPayment/value='99'">
                            <fo:block>Sonstiges</fo:block>
                          </xsl:when>
                          <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/frequencyPayment/value='01'">
                            <fo:block>Täglich</fo:block>
                          </xsl:when>
                          <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/frequencyPayment/value='02'">
                            <fo:block>Wöchentlich</fo:block>
                          </xsl:when>
                          <xsl:when test="//ChangeEntitlementBenefitsInKindLongTermCare/frequencyPayment/value='03'">
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-header background-color="LightGrey">
                            <fo:table-row border="solid 0.2mm Grey">
                              <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                <fo:block>3.4. Füllen Sie bitte folgendes Feld aus, wenn „Zahlungsrhythmus“ = „99 - Sonstiges“:</fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-header>
                          <fo:table-body start-indent="2mm">
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">3.4.1. Sonstiges</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//ChangeEntitlementBenefitsInKindLongTermCare/PleaseFillInFollowingIfFrequencyPaymentOther/other"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">3.4.2. Beschreibung der Leistungen</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//ChangeEntitlementBenefitsInKindLongTermCare/PleaseFillInFollowingIfFrequencyPaymentOther/descriptionBenefits"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-body>
