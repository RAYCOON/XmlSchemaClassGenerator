...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
  <xsl:variable name="filename">XSD2PDF_S077_en-UK_4.4.1_6.0.1.xslt</xsl:variable>
    ...
    <fo:root font-family="Arial Unicode MS" font-size="10pt">
      ...
      <fo:page-sequence master-reference="Standard">
        <fo:static-content flow-name="xsl-region-before">
          <fo:table table-layout="fixed" width="100%" margin="5mm 0mm 0mm 0mm">
            ...
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="14pt" text-align="start">S077 - Cancellation of Entitlement Document - Former Frontier Worker - Family Member of Former Frontier Worker</fo:block>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="8pt" text-align="start">S077 - Cancellation of Entitlement Document - Former Frontier Worker - Family Member of Former Frontier Worker</fo:block>
                </fo:table-cell>
                <fo:table-cell>
        ...
        <fo:flow flow-name="xsl-region-body">
          <fo:block font-family="Arial Unicode MS" font-size="10pt">Article 28 of Regulation (EC) No 883/2004; Article 29 of Regulation (EC) No 987/2009</fo:block>
          <fo:block>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>2. Address of the person for whom the entitlement is cancelled</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                        ...
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-body start-indent="2mm">
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//AddressPersonForWhomEntitlementCancelled/Address/street"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//AddressPersonForWhomEntitlementCancelled/Address/buildingName"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//AddressPersonForWhomEntitlementCancelled/Address/town"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//AddressPersonForWhomEntitlementCancelled/Address/postalCode"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//AddressPersonForWhomEntitlementCancelled/Address/region"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//AddressPersonForWhomEntitlementCancelled/Address/country"/>
                                  <fo:block>
                                    <xsl:choose>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='PR'">
                                        <fo:block>Puerto Rico</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='PS'">
                                        <fo:block>Palestine, State of</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='PT'">
                                        <fo:block>Portugal</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='PW'">
                                        <fo:block>Palau</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='PY'">
                                        <fo:block>Paraguay</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='QA'">
                                        <fo:block>Qatar</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='AD'">
                                        <fo:block>Andorra</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='AE'">
                                        <fo:block>United Arab Emirates (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='AF'">
                                        <fo:block>Afghanistan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='AG'">
                                        <fo:block>Antigua and Barbuda</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='AI'">
                                        <fo:block>Anguilla</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='AL'">
                                        <fo:block>Albania</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='AM'">
                                        <fo:block>Armenia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='AO'">
                                        <fo:block>Angola</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='AQ'">
                                        <fo:block>Antarctica</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='AR'">
                                        <fo:block>Argentina</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='AS'">
                                        <fo:block>American Samoa</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='AT'">
                                        <fo:block>Austria</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='RE'">
                                        <fo:block>Réunion</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='AU'">
                                        <fo:block>Australia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='AW'">
                                        <fo:block>Aruba</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='AX'">
                                        <fo:block>Aland Islands</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='AZ'">
                                        <fo:block>Azerbaijan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='RO'">
                                        <fo:block>Romania</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BA'">
                                        <fo:block>Bosnia and Herzegovina</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BB'">
                                        <fo:block>Barbados</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='RS'">
                                        <fo:block>Serbia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BD'">
                                        <fo:block>Bangladesh</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BE'">
                                        <fo:block>Belgium</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='RU'">
                                        <fo:block>Russian Federation (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BF'">
                                        <fo:block>Burkina Faso</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BG'">
                                        <fo:block>Bulgaria</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='RW'">
                                        <fo:block>Rwanda</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BH'">
                                        <fo:block>Bahrain</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BI'">
                                        <fo:block>Burundi</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BJ'">
                                        <fo:block>Benin</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BL'">
                                        <fo:block>Saint Barthélemy</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BM'">
                                        <fo:block>Bermuda</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BN'">
                                        <fo:block>Brunei Darussalam</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BO'">
                                        <fo:block>Bolivia (Plurinational State of)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='SA'">
                                        <fo:block>Saudi Arabia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BQ'">
                                        <fo:block>Bonaire, Sint Eustatius and Saba</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='SB'">
                                        <fo:block>Solomon Islands</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BR'">
                                        <fo:block>Brazil</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='SC'">
                                        <fo:block>Seychelles</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BS'">
                                        <fo:block>Bahamas (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='SD'">
                                        <fo:block>Sudan (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='SE'">
                                        <fo:block>Sweden</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BT'">
                                        <fo:block>Bhutan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BV'">
                                        <fo:block>Bouvet Island</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='SG'">
                                        <fo:block>Singapore</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BW'">
                                        <fo:block>Botswana</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='SH'">
                                        <fo:block>Saint Helena, Ascension and Tristan da Cunha</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='SI'">
                                        <fo:block>Slovenia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BY'">
                                        <fo:block>Belarus</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='SJ'">
                                        <fo:block>Svalbard and Jan Mayen</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='SK'">
                                        <fo:block>Slovakia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='BZ'">
                                        <fo:block>Belize</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='SL'">
                                        <fo:block>Sierra Leone</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='SM'">
                                        <fo:block>San Marino</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='SN'">
                                        <fo:block>Senegal</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='SO'">
                                        <fo:block>Somalia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='CA'">
                                        <fo:block>Canada</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='SR'">
                                        <fo:block>Suriname</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='CC'">
                                        <fo:block>Cocos (Keeling) Islands (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='SS'">
                                        <fo:block>South Sudan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='CD'">
                                        <fo:block>Congo, the Democratic Republic of the</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='ST'">
                                        <fo:block>Sao Tome and Principe</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='CF'">
                                        <fo:block>Central African Republic (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='SV'">
                                        <fo:block>El Salvador</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='CG'">
                                        <fo:block>Congo</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='CH'">
                                        <fo:block>Switzerland</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='SX'">
                                        <fo:block>Sint Maarten (Dutch part)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='CI'">
                                        <fo:block>Cote d'Ivoire</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='SY'">
                                        <fo:block>Syrian Arab Republic</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='SZ'">
                                        <fo:block>Swaziland</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='CK'">
                                        <fo:block>Cook Islands (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='CL'">
                                        <fo:block>Chile</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='CM'">
                                        <fo:block>Cameroon</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='CN'">
                                        <fo:block>China</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='CO'">
                                        <fo:block>Colombia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='CR'">
                                        <fo:block>Costa Rica</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='TC'">
                                        <fo:block>Turks and Caicos Islands (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='TD'">
                                        <fo:block>Chad</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='CU'">
                                        <fo:block>Cuba</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='TF'">
                                        <fo:block>French Southern Territories (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='CV'">
                                        <fo:block>Cabo Verde</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='TG'">
                                        <fo:block>Togo</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='CW'">
                                        <fo:block>Curaçao</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='TH'">
                                        <fo:block>Thailand</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='CX'">
                                        <fo:block>Christmas Island</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='CY'">
                                        <fo:block>Cyprus</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='TJ'">
                                        <fo:block>Tajikistan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='CZ'">
                                        <fo:block>Czechia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='TK'">
                                        <fo:block>Tokelau</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='TL'">
                                        <fo:block>Timor-Leste</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='TM'">
                                        <fo:block>Turkmenistan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='TN'">
                                        <fo:block>Tunisia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='TO'">
                                        <fo:block>Tonga</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='TR'">
                                        <fo:block>Turkey</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='TT'">
                                        <fo:block>Trinidad and Tobago</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='DE'">
                                        <fo:block>Germany</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='TV'">
                                        <fo:block>Tuvalu</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='TW'">
                                        <fo:block>Taiwan (Province of China)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='DJ'">
                                        <fo:block>Djibouti</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='TZ'">
                                        <fo:block>Tanzania, United Republic of</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='DK'">
                                        <fo:block>Denmark</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='DM'">
                                        <fo:block>Dominica</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='DO'">
                                        <fo:block>Dominican Republic (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='UA'">
                                        <fo:block>Ukraine</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='UG'">
                                        <fo:block>Uganda</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='UK'">
                                        <fo:block>United Kingdom</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='DZ'">
                                        <fo:block>Algeria</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='UM'">
                                        <fo:block>United States Minor Outlying Islands (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='EC'">
                                        <fo:block>Ecuador</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='US'">
                                        <fo:block>United States of America (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='EE'">
                                        <fo:block>Estonia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='EG'">
                                        <fo:block>Egypt</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='EH'">
                                        <fo:block>Western Sahara</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='UY'">
                                        <fo:block>Uruguay</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='UZ'">
                                        <fo:block>Uzbekistan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='EL'">
                                        <fo:block>Greece</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='VA'">
                                        <fo:block>Holy See (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='ER'">
                                        <fo:block>Eritrea</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='VC'">
                                        <fo:block>Saint Vincent and the Grenadines</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='ES'">
                                        <fo:block>Spain</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='ET'">
                                        <fo:block>Ethiopia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='VE'">
                                        <fo:block>Venezuela (Bolivarian Republic of)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='VG'">
                                        <fo:block>Virgin Islands (British)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='VI'">
                                        <fo:block>Virgin Islands (U.S.)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='VN'">
                                        <fo:block>Viet Nam</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='VU'">
                                        <fo:block>Vanuatu</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='FI'">
                                        <fo:block>Finland</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='FJ'">
                                        <fo:block>Fiji</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='FK'">
                                        <fo:block>Falkland Islands (the) [Malvinas]</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='FM'">
                                        <fo:block>Micronesia (Federated States of)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='FO'">
                                        <fo:block>Faroe Islands (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='FR'">
                                        <fo:block>France</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='WF'">
                                        <fo:block>Wallis and Futuna</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='GA'">
                                        <fo:block>Gabon</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='WS'">
                                        <fo:block>Samoa</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='GD'">
                                        <fo:block>Grenada</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='GE'">
                                        <fo:block>Georgia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='GF'">
                                        <fo:block>French Guiana</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='GG'">
                                        <fo:block>Guernsey</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='GH'">
                                        <fo:block>Ghana</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='GI'">
                                        <fo:block>Gibraltar</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='GL'">
                                        <fo:block>Greenland</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='GM'">
                                        <fo:block>Gambia (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='GN'">
                                        <fo:block>Guinea</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='GP'">
                                        <fo:block>Guadeloupe</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='GQ'">
                                        <fo:block>Equatorial Guinea</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='GS'">
                                        <fo:block>South Georgia and the South Sandwich Islands</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='GT'">
                                        <fo:block>Guatemala</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='GU'">
                                        <fo:block>Guam</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='GW'">
                                        <fo:block>Guinea-Bissau</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='GY'">
                                        <fo:block>Guyana</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='XK'">
                                        <fo:block>Kosovo</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='HK'">
                                        <fo:block>Hong Kong</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='HM'">
                                        <fo:block>Heard Island and McDonald Islands</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='HN'">
                                        <fo:block>Honduras</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='HR'">
                                        <fo:block>Croatia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='HT'">
                                        <fo:block>Haiti</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='YE'">
                                        <fo:block>Yemen</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='HU'">
                                        <fo:block>Hungary</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='ID'">
                                        <fo:block>Indonesia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='YT'">
                                        <fo:block>Mayotte</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='IE'">
                                        <fo:block>Ireland</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='IL'">
                                        <fo:block>Israel</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='IM'">
                                        <fo:block>Isle of Man</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='IN'">
                                        <fo:block>India</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='IO'">
                                        <fo:block>British Indian Ocean Territory (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='ZA'">
                                        <fo:block>South Africa</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='IQ'">
                                        <fo:block>Iraq</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='IR'">
                                        <fo:block>Iran (Islamic Republic of)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='IS'">
                                        <fo:block>Iceland</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='IT'">
                                        <fo:block>Italy</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='ZM'">
                                        <fo:block>Zambia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='JE'">
                                        <fo:block>Jersey</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='ZW'">
                                        <fo:block>Zimbabwe</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='JM'">
                                        <fo:block>Jamaica</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='JO'">
                                        <fo:block>Jordan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='JP'">
                                        <fo:block>Japan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='KE'">
                                        <fo:block>Kenya</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='KG'">
                                        <fo:block>Kyrgyzstan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='KH'">
                                        <fo:block>Cambodia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='KI'">
                                        <fo:block>Kiribati</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='KM'">
                                        <fo:block>Comoros</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='KN'">
                                        <fo:block>Saint Kitts and Nevis</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='KP'">
                                        <fo:block>Korea (the Democratic People's Republic of)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='KR'">
                                        <fo:block>Korea (the Republic of)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='KW'">
                                        <fo:block>Kuwait</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='KY'">
                                        <fo:block>Cayman Islands (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='KZ'">
                                        <fo:block>Kazakhstan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='LA'">
                                        <fo:block>Lao People's Democratic Republic (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='LB'">
                                        <fo:block>Lebanon</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='LC'">
                                        <fo:block>Saint Lucia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='LI'">
                                        <fo:block>Liechtenstein</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='LK'">
                                        <fo:block>Sri Lanka</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='LR'">
                                        <fo:block>Liberia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='LS'">
                                        <fo:block>Lesotho</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='LT'">
                                        <fo:block>Lithuania</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='LU'">
                                        <fo:block>Luxembourg</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='LV'">
                                        <fo:block>Latvia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='LY'">
                                        <fo:block>Libya</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MA'">
                                        <fo:block>Morocco</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MC'">
                                        <fo:block>Monaco</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MD'">
                                        <fo:block>Moldova (the Republic of)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='ME'">
                                        <fo:block>Montenegro</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MF'">
                                        <fo:block>Saint Martin (French part)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MG'">
                                        <fo:block>Madagascar</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MH'">
                                        <fo:block>Marshall Islands (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MK'">
                                        <fo:block>Macedonia (the former Yugoslav Republic of)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='ML'">
                                        <fo:block>Mali</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MM'">
                                        <fo:block>Myanmar</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MN'">
                                        <fo:block>Mongolia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MO'">
                                        <fo:block>Macao</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MP'">
                                        <fo:block>Northern Mariana Islands (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MQ'">
                                        <fo:block>Martinique</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MR'">
                                        <fo:block>Mauritania</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MS'">
                                        <fo:block>Montserrat</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MT'">
                                        <fo:block>Malta</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MU'">
                                        <fo:block>Mauritius</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MV'">
                                        <fo:block>Maldives</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MW'">
                                        <fo:block>Malawi</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MX'">
                                        <fo:block>Mexico</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MY'">
                                        <fo:block>Malaysia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='MZ'">
                                        <fo:block>Mozambique</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='NA'">
                                        <fo:block>Namibia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='NC'">
                                        <fo:block>New Caledonia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='NE'">
                                        <fo:block>Niger (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='NF'">
                                        <fo:block>Norfolk Island</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='NG'">
                                        <fo:block>Nigeria</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='NI'">
                                        <fo:block>Nicaragua</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='NL'">
                                        <fo:block>Netherlands (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='NO'">
                                        <fo:block>Norway</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='NP'">
                                        <fo:block>Nepal</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='NR'">
                                        <fo:block>Nauru</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='NU'">
                                        <fo:block>Niue</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='NZ'">
                                        <fo:block>New Zealand</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='OM'">
                                        <fo:block>Oman</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='PA'">
                                        <fo:block>Panama</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='PE'">
                                        <fo:block>Peru</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='PF'">
                                        <fo:block>French Polynesia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='PG'">
                                        <fo:block>Papua New Guinea</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='PH'">
                                        <fo:block>Philippines (the)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='PK'">
                                        <fo:block>Pakistan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='PL'">
                                        <fo:block>Poland</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='PM'">
                                        <fo:block>Saint Pierre and Miquelon</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPersonForWhomEntitlementCancelled/Address/country/value='PN'">
                                        <fo:block>Pitcairn</fo:block>
                                      </xsl:when>
                                      <xsl:otherwise>
                                        <fo:block>-/-</fo:block>
                ...
                <fo:table-row>
                  ...
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//AddressPersonForWhomEntitlementCancelled/residenceInThisCountrySince"/>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-body>
                      ...
                      <fo:block>
                        <xsl:choose>
                          <xsl:when test="//Status/status/value='01'">
                            <fo:block>Former Frontier Worker</fo:block>
                          </xsl:when>
                          <xsl:when test="//Status/status/value='02'">
                            <fo:block>Family member of a former frontier worker</fo:block>
                          </xsl:when>
                          <xsl:otherwise>
                            <fo:block>-/-</fo:block>
                          </xsl:otherwise>
            ...
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-body start-indent="2mm">
                <fo:table-row>
                  ...
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//InformationConcerningEntitlementDocument/entitlementDocument"/>
                      <fo:block>
                        <xsl:choose>
                          <xsl:when test="//InformationConcerningEntitlementDocument/entitlementDocument/value='01'">
                            <fo:block>SED S008</fo:block>
                          </xsl:when>
                          <xsl:when test="//InformationConcerningEntitlementDocument/entitlementDocument/value='02'">
                            <fo:block>PD S3</fo:block>
                          </xsl:when>
                          <xsl:otherwise>
                            <fo:block>-/-</fo:block>
                          </xsl:otherwise>
                                    ...
                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                      ...
                                      <fo:table-body start-indent="2mm">
                                        <fo:table-row>
                                          ...
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//InformationConcerningEntitlementDocument/PeriodEntitlement/FixedPeriod/startDate"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                        <fo:table-row>
                                          ...
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//InformationConcerningEntitlementDocument/PeriodEntitlement/FixedPeriod/endDate"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-body>
                                    ...
                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                      ...
                                      <fo:table-body start-indent="2mm">
                                        <fo:table-row>
                                          ...
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//InformationConcerningEntitlementDocument/PeriodEntitlement/OpenPeriod/typeOpenPeriod"/>
                                              <fo:block>
                                                <xsl:choose>
                                                  <xsl:when test="//InformationConcerningEntitlementDocument/PeriodEntitlement/OpenPeriod/typeOpenPeriod/value='01'">
                                                    <fo:block>Open-Ended Period</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationConcerningEntitlementDocument/PeriodEntitlement/OpenPeriod/typeOpenPeriod/value='98'">
                                        ...
                                        <fo:table-row>
                                          ...
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//InformationConcerningEntitlementDocument/PeriodEntitlement/OpenPeriod/startDate"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-body>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-body start-indent="2mm">
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">5.1. End date of entitlement</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//Cancellation/endDateEntitlement"/>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">5.2. Reason for cancellation</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//Cancellation/reasonForCancellation"/>
                      <fo:block>
                        <xsl:choose>
                          <xsl:when test="//Cancellation/reasonForCancellation/value='99'">
                            <fo:block>Other reason</fo:block>
                          </xsl:when>
                          <xsl:when test="//Cancellation/reasonForCancellation/value='01'">
                            <fo:block>No longer entitled to benefits in kind from our Member State</fo:block>
                          </xsl:when>
                          <xsl:when test="//Cancellation/reasonForCancellation/value='02'">
                            <fo:block>Insured on the basis of an activity as an employed or self-employed person</fo:block>
                          </xsl:when>
                          <xsl:when test="//Cancellation/reasonForCancellation/value='03'">
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-header background-color="LightGrey">
                            <fo:table-row border="solid 0.2mm Grey">
                              <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                <fo:block>5.3. Please fill in the following if \Reason for cancellation\ = \Other reason\ :</fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-header>
                          <fo:table-body start-indent="2mm">
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">5.3.1. Other reason</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//Cancellation/FillInIfReasonsForCancellation/otherReason"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-body>
