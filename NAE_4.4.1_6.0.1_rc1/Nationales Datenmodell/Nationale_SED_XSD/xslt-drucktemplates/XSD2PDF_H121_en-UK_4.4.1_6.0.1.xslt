...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
  <xsl:variable name="filename">XSD2PDF_H121_en-UK_4.4.1_6.0.1.xslt</xsl:variable>
    ...
    <fo:root font-family="Arial Unicode MS" font-size="10pt">
      ...
      <fo:page-sequence master-reference="Standard">
        <fo:static-content flow-name="xsl-region-before">
          <fo:table table-layout="fixed" width="100%" margin="5mm 0mm 0mm 0mm">
            ...
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="14pt" text-align="start">H121 - Notification of Medical Information / Reply to request for Medical Information</fo:block>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="8pt" text-align="start">H121 - Notification of Medical Information / Reply to request for Medical Information</fo:block>
                </fo:table-cell>
                <fo:table-cell>
        ...
        <fo:flow flow-name="xsl-region-body">
          <fo:block font-family="Arial Unicode MS" font-size="10pt">Articles 21, 34, 36(3), 82 of Regulation (EC) No 883/2004; Articles 27(5)(6)(10),28 (3)(5), 33(1), 87(1)(2)(4) of Regulation (EC) No 987/2009</fo:block>
          <fo:block>
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-body start-indent="2mm">
                            ...
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">1.2.3. Previous forename</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>2. Reply to request for estimated costs of Medical Evidence/Examination</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-body start-indent="2mm">
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">2.1.1. Amount</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//ReplyRequestForEstimatedCostsMedicalEvidence/ReplyRequestForEstimatedCostsMedicalEvidence/amount"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">2.1.2. Currency</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//ReplyRequestForEstimatedCostsMedicalEvidence/ReplyRequestForEstimatedCostsMedicalEvidence/currency"/>
                                  <fo:block>
                                    <xsl:choose>
                                      <xsl:when test="//ReplyRequestForEstimatedCostsMedicalEvidence/ReplyRequestForEstimatedCostsMedicalEvidence/currency/value='HRK'">
                                        <fo:block>Croatian Kuna</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ReplyRequestForEstimatedCostsMedicalEvidence/ReplyRequestForEstimatedCostsMedicalEvidence/currency/value='CHF'">
                                        <fo:block>Swiss Franc</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ReplyRequestForEstimatedCostsMedicalEvidence/ReplyRequestForEstimatedCostsMedicalEvidence/currency/value='ISK'">
                                        <fo:block>Icelandic Krona</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ReplyRequestForEstimatedCostsMedicalEvidence/ReplyRequestForEstimatedCostsMedicalEvidence/currency/value='EUR'">
                                        <fo:block>Euro</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ReplyRequestForEstimatedCostsMedicalEvidence/ReplyRequestForEstimatedCostsMedicalEvidence/currency/value='LVL'">
                                        <fo:block>Latvian Lats</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ReplyRequestForEstimatedCostsMedicalEvidence/ReplyRequestForEstimatedCostsMedicalEvidence/currency/value='DKK'">
                                        <fo:block>Danish Krone</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ReplyRequestForEstimatedCostsMedicalEvidence/ReplyRequestForEstimatedCostsMedicalEvidence/currency/value='LTL'">
                                        <fo:block>Lithuanian Litas</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ReplyRequestForEstimatedCostsMedicalEvidence/ReplyRequestForEstimatedCostsMedicalEvidence/currency/value='BGN'">
                                        <fo:block>Bulgarian Lev</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ReplyRequestForEstimatedCostsMedicalEvidence/ReplyRequestForEstimatedCostsMedicalEvidence/currency/value='NOK'">
                                        <fo:block>Norwegian Krone</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ReplyRequestForEstimatedCostsMedicalEvidence/ReplyRequestForEstimatedCostsMedicalEvidence/currency/value='RON'">
                                        <fo:block>Romanian New Leu</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ReplyRequestForEstimatedCostsMedicalEvidence/ReplyRequestForEstimatedCostsMedicalEvidence/currency/value='PLN'">
                                        <fo:block>Polish Zloty</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ReplyRequestForEstimatedCostsMedicalEvidence/ReplyRequestForEstimatedCostsMedicalEvidence/currency/value='GBP'">
                                        <fo:block>British Pound</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ReplyRequestForEstimatedCostsMedicalEvidence/ReplyRequestForEstimatedCostsMedicalEvidence/currency/value='CZK'">
                                        <fo:block>Czech Koruna</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ReplyRequestForEstimatedCostsMedicalEvidence/ReplyRequestForEstimatedCostsMedicalEvidence/currency/value='HUF'">
                                        <fo:block>Hungarian Forint</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ReplyRequestForEstimatedCostsMedicalEvidence/ReplyRequestForEstimatedCostsMedicalEvidence/currency/value='SEK'">
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>3. Reply to request for Medical Examination/Report</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-header background-color="LightGrey">
                            <fo:table-row border="solid 0.2mm Grey">
                              <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                <fo:block>3.1. Reply to request for Medical Examination/Report</fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-header>
                          <fo:table-body start-indent="2mm">
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">3.1.1. In reply to your request concerning the medical examination we inform you that it</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//ReplyRequestForMedicalExaminationReport/ReplyRequestForMedicalExaminationReport/inReplyRequestConcerningMedicalExaminationInformIt"/>
                                  <fo:block>
                                    <xsl:choose>
                                      <xsl:when test="//ReplyRequestForMedicalExaminationReport/ReplyRequestForMedicalExaminationReport/inReplyRequestConcerningMedicalExaminationInformIt/value='01'">
                                        <fo:block>Was carried out, the requested report is attached</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ReplyRequestForMedicalExaminationReport/ReplyRequestForMedicalExaminationReport/inReplyRequestConcerningMedicalExaminationInformIt/value='02'">
                                        <fo:block>Was not carried out for the following reason</fo:block>
                                      </xsl:when>
                                      <xsl:otherwise>
                                        <fo:block>-/-</fo:block>
                                      </xsl:otherwise>
                            ...
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">3.1.2. Reason for not carrying out the medical examination</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//ReplyRequestForMedicalExaminationReport/ReplyRequestForMedicalExaminationReport/reasonForNotCarryingOutMedicalExamination"/>
                                  <fo:block>
                                    <xsl:choose>
                                      <xsl:when test="//ReplyRequestForMedicalExaminationReport/ReplyRequestForMedicalExaminationReport/reasonForNotCarryingOutMedicalExamination/value='99'">
                                        <fo:block>Other</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ReplyRequestForMedicalExaminationReport/ReplyRequestForMedicalExaminationReport/reasonForNotCarryingOutMedicalExamination/value='01'">
                                        <fo:block>Person did not come for examination</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ReplyRequestForMedicalExaminationReport/ReplyRequestForMedicalExaminationReport/reasonForNotCarryingOutMedicalExamination/value='02'">
                                        <fo:block>Person did not wish to co-operate</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ReplyRequestForMedicalExaminationReport/ReplyRequestForMedicalExaminationReport/reasonForNotCarryingOutMedicalExamination/value='03'">
                                        <fo:block>Person moved, new address unknown</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ReplyRequestForMedicalExaminationReport/ReplyRequestForMedicalExaminationReport/reasonForNotCarryingOutMedicalExamination/value='04'">
                                        <fo:block>Person died</fo:block>
                                      </xsl:when>
                                      <xsl:otherwise>
                                        <fo:block>-/-</fo:block>
                                      </xsl:otherwise>
                                  ...
                                  <fo:block>
                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                      ...
                                      <fo:table-header background-color="LightGrey">
                                        <fo:table-row border="solid 0.2mm Grey">
                                          <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>3.1.3. Please fill in the following if \Reason for not carrying out the medical examination\ = \Other\ :</fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-header>
                                      <fo:table-body start-indent="2mm">
                                        <fo:table-row>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block wrap-option="wrap">3.1.3.1. Other reason</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//ReplyRequestForMedicalExaminationReport/ReplyRequestForMedicalExaminationReport/FillInIfReasonForNotCarryingOut/otherReason"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-body>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>4. Reply to request for Medical Evidence</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-header background-color="LightGrey">
                            <fo:table-row border="solid 0.2mm Grey">
                              <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                <fo:block>4.1. Reply to request for Medical Evidence</fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-header>
                          <fo:table-body start-indent="2mm">
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">4.1.1. In reply to your request for the medical evidence, we attached the requested medical evidence.</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//ReplyRequestForMedicalEvidence/ReplyRequestForMedicalEvidence/replyAttachedRequestedMedicalEvidenceIndicator"/>
                                  <fo:block>
                                    <xsl:choose>
                                      <xsl:when test="//ReplyRequestForMedicalEvidence/ReplyRequestForMedicalEvidence/replyAttachedRequestedMedicalEvidenceIndicator/value='0'">
                                        <fo:block>No</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//ReplyRequestForMedicalEvidence/ReplyRequestForMedicalEvidence/replyAttachedRequestedMedicalEvidenceIndicator/value='1'">
                            ...
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">4.1.2. Reasons for not sending the requested medical evidence</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//ReplyRequestForMedicalEvidence/ReplyRequestForMedicalEvidence/reasonsForNotSendingRequestedMedicalEvidence"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-body>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>5. Notification of Medical Information</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-header background-color="LightGrey">
                            <fo:table-row border="solid 0.2mm Grey">
                              <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                <fo:block>5.1. Notification of Medical Information</fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-header>
                          <fo:table-body start-indent="2mm">
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">5.1.1. Please find attached:</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//NotificationMedicalInformation/NotificationMedicalInformation/pleaseFindAttached"/>
                                  <fo:block>
                                    <xsl:for-each select="//NotificationMedicalInformation/NotificationMedicalInformation/pleaseFindAttached/value">
                                      <xsl:choose>
                                        <xsl:when test=".='99'">
                                          <fo:block>Other medical information</fo:block>
                                        </xsl:when>
                                        <xsl:when test=".='01'">
                                          <fo:block>Medical Examination/Report</fo:block>
                                        </xsl:when>
                                        <xsl:when test=".='02'">
                                          <fo:block>Medical Evidence</fo:block>
                                        </xsl:when>
                                        <xsl:otherwise>
                                          <fo:block>-/-</fo:block>
                                        </xsl:otherwise>
                            ...
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">5.1.2. Other medical information</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//NotificationMedicalInformation/NotificationMedicalInformation/otherMedicalInformation"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-body>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>6. Additional information</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">6.1. Additional information</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
