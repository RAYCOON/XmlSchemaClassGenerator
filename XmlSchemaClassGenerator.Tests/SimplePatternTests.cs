...
namespace XmlSchemaClassGenerator.Tests
{
    public class SimplePatternTests
    {
        ...
        public void TestNamespacePattern_Creation()
        {
            ...
            Assert.Equal("Filename", pattern.Source);
        ...
        public void TestGeneratorConfiguration_NewProperties()
        {
            ...
            config.NamespacePatterns = new List<NamespacePattern>();
            config.OutputFilenamePatterns = new List<OutputFilenamePattern>();
            ...
            Assert.NotNull(config.OutputFilenamePatterns);
        ...
        public void TestGenerator_NewProperties()
        {
            ...
            generator.NamespacePatterns = new List<NamespacePattern>();
            generator.OutputFilenamePatterns = new List<OutputFilenamePattern>();
            generator.DefaultNamespaceTemplate = "Test";
            generator.DefaultNamespaceStrategy = DefaultNamespaceStrategy.UseTemplate;
            
            Assert.NotNull(generator.NamespacePatterns);
            Assert.NotNull(generator.OutputFilenamePatterns);
