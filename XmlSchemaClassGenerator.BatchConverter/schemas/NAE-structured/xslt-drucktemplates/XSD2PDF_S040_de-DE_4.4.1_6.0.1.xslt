...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
  <xsl:variable name="filename">XSD2PDF_S040_de-DE_4.4.1_6.0.1.xslt</xsl:variable>
        ...
        <fo:static-content flow-name="xsl-region-before">
          <fo:table table-layout="fixed" width="100%" margin="5mm 0mm 0mm 0mm">
            ...
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="14pt" text-align="start">S040 - Auskunftsersuchen zu Zeiten - Art des Versicherungsrisikos: Krankheit, Mutterschaft oder Vaterschaft</fo:block>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="8pt" text-align="start">S040 - Request for Periods - Insurance Risk Type: Sickness, Maternity or Paternity</fo:block>
                </fo:table-cell>
                <fo:table-cell>
            ...
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-body start-indent="2mm">
                        ...
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-body start-indent="2mm">
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//AddressPerson/Address/street"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//AddressPerson/Address/buildingName"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//AddressPerson/Address/town"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//AddressPerson/Address/postalCode"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//AddressPerson/Address/region"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//AddressPerson/Address/country"/>
                                  <fo:block>
                                    <xsl:choose>
                                      <xsl:when test="//AddressPerson/Address/country/value='PR'">
                                        <fo:block>Puerto Rico</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='PS'">
                                        <fo:block>Palästina (Staat)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='PT'">
                                        <fo:block>Portugal</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='PW'">
                                        <fo:block>Palau</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='PY'">
                                        <fo:block>Paraguay</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='QA'">
                                        <fo:block>Katar</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='AD'">
                                        <fo:block>Andorra</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='AE'">
                                        <fo:block>Vereinigte Arabische Emirate</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='AF'">
                                        <fo:block>Afghanistan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='AG'">
                                        <fo:block>Antigua und Barbuda</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='AI'">
                                        <fo:block>Anguilla</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='AL'">
                                        <fo:block>Albanien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='AM'">
                                        <fo:block>Armenien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='AO'">
                                        <fo:block>Angola</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='AQ'">
                                        <fo:block>Antarktis</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='AR'">
                                        <fo:block>Argentinien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='AS'">
                                        <fo:block>Amerikanisch-Samoa</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='AT'">
                                        <fo:block>Österreich</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='RE'">
                                        <fo:block>Réunion</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='AU'">
                                        <fo:block>Australien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='AW'">
                                        <fo:block>Aruba</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='AX'">
                                        <fo:block>Ålandinseln</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='AZ'">
                                        <fo:block>Aserbaidschan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='RO'">
                                        <fo:block>Rumänien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BA'">
                                        <fo:block>Bosnien und Herzegowina</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BB'">
                                        <fo:block>Barbados</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='RS'">
                                        <fo:block>Serbien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BD'">
                                        <fo:block>Bangladesch</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BE'">
                                        <fo:block>Belgien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='RU'">
                                        <fo:block>Russische Föderation</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BF'">
                                        <fo:block>Burkina Faso</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BG'">
                                        <fo:block>Bulgarien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='RW'">
                                        <fo:block>Ruanda</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BH'">
                                        <fo:block>Bahrain</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BI'">
                                        <fo:block>Burundi</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BJ'">
                                        <fo:block>Benin</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BL'">
                                        <fo:block>Saint-Barthélemy</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BM'">
                                        <fo:block>Bermuda</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BN'">
                                        <fo:block>Brunei Darussalam</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BO'">
                                        <fo:block>Bolivien, Plurinationaler Staat</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='SA'">
                                        <fo:block>Saudi-Arabien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BQ'">
                                        <fo:block>Bonaire, St. Eustatius und Saba</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='SB'">
                                        <fo:block>Salomonen (Salomon-Inseln)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BR'">
                                        <fo:block>Brasilien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='SC'">
                                        <fo:block>Seychellen</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BS'">
                                        <fo:block>Bahamas</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='SD'">
                                        <fo:block>Sudan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='SE'">
                                        <fo:block>Schweden</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BT'">
                                        <fo:block>Bhutan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BV'">
                                        <fo:block>Bouvetinsel</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='SG'">
                                        <fo:block>Singapur</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BW'">
                                        <fo:block>Botswana</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='SH'">
                                        <fo:block>St. Helena, Ascension und Tristan da Cunha</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='SI'">
                                        <fo:block>Slowenien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BY'">
                                        <fo:block>Belarus</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='SJ'">
                                        <fo:block>Svalbard und Jan Mayen</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='SK'">
                                        <fo:block>Slowakei</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='BZ'">
                                        <fo:block>Belize</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='SL'">
                                        <fo:block>Sierra Leone</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='SM'">
                                        <fo:block>San Marino</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='SN'">
                                        <fo:block>Senegal</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='SO'">
                                        <fo:block>Somalia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='CA'">
                                        <fo:block>Kanada</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='SR'">
                                        <fo:block>Suriname</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='CC'">
                                        <fo:block>Kokosinseln (Keelinginseln)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='SS'">
                                        <fo:block>Südsudan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='CD'">
                                        <fo:block>Kongo, Demokratische Republik</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='ST'">
                                        <fo:block>São Tomé und Príncipe</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='CF'">
                                        <fo:block>Zentralafrikanische Republik</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='SV'">
                                        <fo:block>El Salvador</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='CG'">
                                        <fo:block>Kongo</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='CH'">
                                        <fo:block>Schweiz</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='SX'">
                                        <fo:block>Sint Maarten (niederländischer Teil)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='CI'">
                                        <fo:block>Côte d'Ivoire</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='SY'">
                                        <fo:block>Arabische Republik Syrien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='SZ'">
                                        <fo:block>Swasiland</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='CK'">
                                        <fo:block>Cookinseln</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='CL'">
                                        <fo:block>Chile</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='CM'">
                                        <fo:block>Kamerun</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='CN'">
                                        <fo:block>China</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='CO'">
                                        <fo:block>Kolumbien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='CR'">
                                        <fo:block>Costa Rica</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='TC'">
                                        <fo:block>Turks- und Caicosinseln</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='TD'">
                                        <fo:block>Tschad</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='CU'">
                                        <fo:block>Kuba</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='TF'">
                                        <fo:block>Französische Süd- und Antarktisgebiete</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='CV'">
                                        <fo:block>Kap Verde</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='TG'">
                                        <fo:block>Togo</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='CW'">
                                        <fo:block>Curaçao</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='TH'">
                                        <fo:block>Thailand</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='CX'">
                                        <fo:block>Weihnachtsinsel</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='CY'">
                                        <fo:block>Zypern</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='TJ'">
                                        <fo:block>Tadschikistan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='CZ'">
                                        <fo:block>Tschechien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='TK'">
                                        <fo:block>Tokelau</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='TL'">
                                        <fo:block>Timor-Leste</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='TM'">
                                        <fo:block>Turkmenistan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='TN'">
                                        <fo:block>Tunesien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='TO'">
                                        <fo:block>Tonga</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='TR'">
                                        <fo:block>Türkei</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='TT'">
                                        <fo:block>Trinidad und Tobago</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='DE'">
                                        <fo:block>Deutschland</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='TV'">
                                        <fo:block>Tuvalu</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='TW'">
                                        <fo:block>Taiwan (Chinesische Provinz)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='DJ'">
                                        <fo:block>Dschibuti</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='TZ'">
                                        <fo:block>Tansania, Vereinigte Republik</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='DK'">
                                        <fo:block>Dänemark</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='DM'">
                                        <fo:block>Dominica</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='DO'">
                                        <fo:block>Dominikanische Republik</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='UA'">
                                        <fo:block>Ukraine</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='UG'">
                                        <fo:block>Uganda</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='UK'">
                                        <fo:block>Vereinigtes Königreich</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='DZ'">
                                        <fo:block>Algerien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='UM'">
                                        <fo:block>Kleinere Amerikanische Überseeinseln</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='EC'">
                                        <fo:block>Ecuador</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='US'">
                                        <fo:block>Vereinigte Staaten von Amerika</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='EE'">
                                        <fo:block>Estland</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='EG'">
                                        <fo:block>Ägypten</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='EH'">
                                        <fo:block>Westsahara</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='UY'">
                                        <fo:block>Uruguay</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='UZ'">
                                        <fo:block>Usbekistan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='EL'">
                                        <fo:block>Griechenland</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='VA'">
                                        <fo:block>Heiliger Stuhl</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='ER'">
                                        <fo:block>Eritrea</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='VC'">
                                        <fo:block>St. Vincent und die Grenadinen</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='ES'">
                                        <fo:block>Spanien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='ET'">
                                        <fo:block>Äthiopien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='VE'">
                                        <fo:block>Venezuela (Bolivarische Republik)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='VG'">
                                        <fo:block>Jungferninseln (Britische)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='VI'">
                                        <fo:block>Jungferninseln (Amerikanische)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='VN'">
                                        <fo:block>Vietnam</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='VU'">
                                        <fo:block>Vanuatu</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='FI'">
                                        <fo:block>Finnland</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='FJ'">
                                        <fo:block>Fidschi</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='FK'">
                                        <fo:block>Falklandinseln / (Malwinen)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='FM'">
                                        <fo:block>Mikronesien (Föderierte Staaten)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='FO'">
                                        <fo:block>Färöer-Inseln</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='FR'">
                                        <fo:block>Frankreich</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='WF'">
                                        <fo:block>Wallis und Futuna</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='GA'">
                                        <fo:block>Gabun</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='WS'">
                                        <fo:block>Samoa</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='GD'">
                                        <fo:block>Grenada</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='GE'">
                                        <fo:block>Georgien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='GF'">
                                        <fo:block>Französisch-Guayana</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='GG'">
                                        <fo:block>Guernsey</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='GH'">
                                        <fo:block>Ghana</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='GI'">
                                        <fo:block>Gibraltar</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='GL'">
                                        <fo:block>Grönland</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='GM'">
                                        <fo:block>Gambia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='GN'">
                                        <fo:block>Guinea</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='GP'">
                                        <fo:block>Guadeloupe</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='GQ'">
                                        <fo:block>Äquatorialguinea</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='GS'">
                                        <fo:block>Südgeorgien und die Südlichen Sandwichinseln</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='GT'">
                                        <fo:block>Guatemala</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='GU'">
                                        <fo:block>Guam</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='GW'">
                                        <fo:block>Guinea-Bissau</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='GY'">
                                        <fo:block>Guyana</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='XK'">
                                        <fo:block>Kosovo</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='HK'">
                                        <fo:block>Hongkong</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='HM'">
                                        <fo:block>Heard und die McDonaldinseln</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='HN'">
                                        <fo:block>Honduras</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='HR'">
                                        <fo:block>Kroatien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='HT'">
                                        <fo:block>Haiti</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='YE'">
                                        <fo:block>Jemen</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='HU'">
                                        <fo:block>Ungarn</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='ID'">
                                        <fo:block>Indonesien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='YT'">
                                        <fo:block>Mayotte</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='IE'">
                                        <fo:block>Irland</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='IL'">
                                        <fo:block>Israel</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='IM'">
                                        <fo:block>Isle of Man</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='IN'">
                                        <fo:block>Indien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='IO'">
                                        <fo:block>Britisches Territorium im Indischen Ozean</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='ZA'">
                                        <fo:block>Südafrika</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='IQ'">
                                        <fo:block>Irak</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='IR'">
                                        <fo:block>Iran (Islamische Republik)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='IS'">
                                        <fo:block>Island</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='IT'">
                                        <fo:block>Italien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='ZM'">
                                        <fo:block>Sambia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='JE'">
                                        <fo:block>Jersey</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='ZW'">
                                        <fo:block>Simbabwe</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='JM'">
                                        <fo:block>Jamaika</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='JO'">
                                        <fo:block>Jordanien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='JP'">
                                        <fo:block>Japan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='KE'">
                                        <fo:block>Kenia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='KG'">
                                        <fo:block>Kirgisistan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='KH'">
                                        <fo:block>Kambodscha</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='KI'">
                                        <fo:block>Kiribati</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='KM'">
                                        <fo:block>Komoren</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='KN'">
                                        <fo:block>St. Kitts und Nevis</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='KP'">
                                        <fo:block>Korea (Demokratische Volksrepublik)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='KR'">
                                        <fo:block>Korea (Republik)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='KW'">
                                        <fo:block>Kuwait</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='KY'">
                                        <fo:block>Cayman Islands</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='KZ'">
                                        <fo:block>Kasachstan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='LA'">
                                        <fo:block>Laos, Demokratische Volksrepublik</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='LB'">
                                        <fo:block>Libanon</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='LC'">
                                        <fo:block>St. Lucia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='LI'">
                                        <fo:block>Liechtenstein</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='LK'">
                                        <fo:block>Sri Lanka</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='LR'">
                                        <fo:block>Liberia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='LS'">
                                        <fo:block>Lesotho</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='LT'">
                                        <fo:block>Litauen</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='LU'">
                                        <fo:block>Luxemburg</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='LV'">
                                        <fo:block>Lettland</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='LY'">
                                        <fo:block>Libyen</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MA'">
                                        <fo:block>Marokko</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MC'">
                                        <fo:block>Monaco</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MD'">
                                        <fo:block>Moldawien (Republik)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='ME'">
                                        <fo:block>Montenegro</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MF'">
                                        <fo:block>St. Martin (französischer Teil)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MG'">
                                        <fo:block>Madagaskar</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MH'">
                                        <fo:block>Marshallinseln</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MK'">
                                        <fo:block>Mazedonien (ehemalige jugoslawische Republik)</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='ML'">
                                        <fo:block>Mali</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MM'">
                                        <fo:block>Myanmar</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MN'">
                                        <fo:block>Mongolei</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MO'">
                                        <fo:block>Macau</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MP'">
                                        <fo:block>Nördliche Marianen</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MQ'">
                                        <fo:block>Martinique</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MR'">
                                        <fo:block>Mauretanien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MS'">
                                        <fo:block>Montserrat</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MT'">
                                        <fo:block>Malta</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MU'">
                                        <fo:block>Mauritius</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MV'">
                                        <fo:block>Malediven</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MW'">
                                        <fo:block>Malawi</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MX'">
                                        <fo:block>Mexiko</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MY'">
                                        <fo:block>Malaysia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='MZ'">
                                        <fo:block>Mosambik</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='NA'">
                                        <fo:block>Namibia</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='NC'">
                                        <fo:block>Neukaledonien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='NE'">
                                        <fo:block>Niger</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='NF'">
                                        <fo:block>Norfolkinseln</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='NG'">
                                        <fo:block>Nigeria</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='NI'">
                                        <fo:block>Nicaragua</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='NL'">
                                        <fo:block>Niederlande</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='NO'">
                                        <fo:block>Norwegen</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='NP'">
                                        <fo:block>Nepal</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='NR'">
                                        <fo:block>Nauru</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='NU'">
                                        <fo:block>Niue</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='NZ'">
                                        <fo:block>Neuseeland</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='OM'">
                                        <fo:block>Oman</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='PA'">
                                        <fo:block>Panama</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='PE'">
                                        <fo:block>Peru</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='PF'">
                                        <fo:block>Französisch-Polynesien</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='PG'">
                                        <fo:block>Papua-Neuguinea</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='PH'">
                                        <fo:block>Philippinen</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='PK'">
                                        <fo:block>Pakistan</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='PL'">
                                        <fo:block>Polen</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='PM'">
                                        <fo:block>St. Pierre und Miquelon</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//AddressPerson/Address/country/value='PN'">
                                        <fo:block>Pitcairninseln</fo:block>
                                      </xsl:when>
                                      <xsl:otherwise>
                                        <fo:block>-/-</fo:block>
                ...
                <fo:table-row>
                  ...
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//AddressPerson/residenceInThisCountrySince"/>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-body>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-body start-indent="2mm">
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">3.1. Als zuständiger Träger, nach dessen Rechtsvorschriften der Erwerb, die Aufrechterhaltung, die Dauer oder das Wiederaufleben des Anspruchs auf Leistungen von der Zurücklegung bestimmter Zeiten abhängig sind, bitten wir Sie, die relevanten Zeiten einer Versicherung, Beschäftigung, selbstständigen Erwerbstätigkeit bzw. Wohnzeiten, die die betreffende Person gemäß Ihren Rechtsvorschriften zurückgelegt hat, zu bestätigen.</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//Request/ActingCompetentInstitutionWhoseLegislation"/>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">3.2. Betrifft Leistungen bei:</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//Request/typeBenefitConcerned"/>
                      <fo:block>
                        <xsl:choose>
                          <xsl:when test="//Request/typeBenefitConcerned/value='01'">
                            <fo:block>Krankheit</fo:block>
                          </xsl:when>
                          <xsl:when test="//Request/typeBenefitConcerned/value='02'">
                            <fo:block>Mutterschaft</fo:block>
                          </xsl:when>
                          <xsl:when test="//Request/typeBenefitConcerned/value='03'">
                            <fo:block>Vaterschaft</fo:block>
                          </xsl:when>
                          <xsl:otherwise>
                            <fo:block>-/-</fo:block>
                          </xsl:otherwise>
                ...
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">3.3. Art der betreffenden Leistung</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//Request/natureBenefitConcerned"/>
                      <fo:block>
                        <xsl:choose>
                          <xsl:when test="//Request/natureBenefitConcerned/value='01'">
                            <fo:block>Geldleistung</fo:block>
                          </xsl:when>
                          <xsl:when test="//Request/natureBenefitConcerned/value='02'">
                            <fo:block>Sachleistung</fo:block>
                          </xsl:when>
                          <xsl:otherwise>
                            <fo:block>-/-</fo:block>
                          </xsl:otherwise>
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-header background-color="LightGrey">
                            <fo:table-row border="solid 0.2mm Grey">
                              <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                <fo:block>3.4. Betreffender Zeitraum</fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-header>
                          <fo:table-body start-indent="2mm">
                                  ...
                                  <fo:block>
                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                      ...
                                      <fo:table-header background-color="LightGrey">
                                        <fo:table-row border="solid 0.2mm Grey">
                                          <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>3.4.1. Feststehender Zeitraum</fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-header>
                                      <fo:table-body start-indent="2mm">
                                        <fo:table-row>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block wrap-option="wrap">3.4.1.1. Datum Beginn</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//Request/PeriodConcerned/FixedPeriod/startDate"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                        <fo:table-row>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block wrap-option="wrap">3.4.1.2. Datum Ende</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//Request/PeriodConcerned/FixedPeriod/endDate"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-body>
                                  ...
                                  <fo:block>
                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                      ...
                                      <fo:table-header background-color="LightGrey">
                                        <fo:table-row border="solid 0.2mm Grey">
                                          <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>3.4.2. Offener Zeitraum</fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-header>
                                      <fo:table-body start-indent="2mm">
                                        <fo:table-row>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block wrap-option="wrap">3.4.2.1. Art des offenen Zeitraums</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//Request/PeriodConcerned/OpenPeriod/typeOpenPeriod"/>
                                              <fo:block>
                                                <xsl:choose>
                                                  <xsl:when test="//Request/PeriodConcerned/OpenPeriod/typeOpenPeriod/value='01'">
                                                    <fo:block>Unbefristeter Zeitraum</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Request/PeriodConcerned/OpenPeriod/typeOpenPeriod/value='98'">
                                        ...
                                        <fo:table-row>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block wrap-option="wrap">3.4.2.2. Datum Beginn</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//Request/PeriodConcerned/OpenPeriod/startDate"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-body>
