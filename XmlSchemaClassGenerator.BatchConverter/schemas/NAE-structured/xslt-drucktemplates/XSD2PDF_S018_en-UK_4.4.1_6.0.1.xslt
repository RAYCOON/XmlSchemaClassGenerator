...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
  <xsl:variable name="filename">XSD2PDF_S018_en-UK_4.4.1_6.0.1.xslt</xsl:variable>
        ...
        <fo:static-content flow-name="xsl-region-before">
          <fo:table table-layout="fixed" width="100%" margin="5mm 0mm 0mm 0mm">
            ...
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="14pt" text-align="start">S018 - Cancellation of registration</fo:block>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="8pt" text-align="start">S018 - Cancellation of registration</fo:block>
                </fo:table-cell>
                <fo:table-cell>
                        ...
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-body start-indent="2mm">
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/familyName"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/forename"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/dateBirth"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/sex"/>
                                  <fo:block>
                                    <xsl:choose>
                                      <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/sex/value='01'">
                                        <fo:block>Male</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/sex/value='02'">
                                        <fo:block>Female</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/sex/value='98'">
                                        <fo:block>Unknown</fo:block>
                                      </xsl:when>
                                      <xsl:otherwise>
                                        <fo:block>-/-</fo:block>
                            ...
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/familyNameAtBirth"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                              ...
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/forenameAtBirth"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                                ...
                                <fo:block>
                                  <fo:block>
                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                      ...
                                      <fo:table-body start-indent="2mm">
                                        <xsl:for-each select="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/PINPersonInEachInstitution/PersonalIdentificationNumber">
                                          <fo:table-row>
                                            <fo:table-cell number-columns-spanned="2">
                                              <fo:block>
                                                <fo:block>
                                        ...
                                        <xsl:if test="not(//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/PINPersonInEachInstitution/PersonalIdentificationNumber)">
                                          <fo:table-row>
                                            <fo:table-cell number-columns-spanned="2">
                                              <fo:block/>
                                            </fo:table-cell>
                                    ...
                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                      ...
                                      <fo:table-body start-indent="2mm">
                                                ...
                                                <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                                  ...
                                                  <fo:table-body start-indent="2mm">
                                                    <fo:table-row>
                                                      ...
                                                      <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                        <fo:block>
                                                          <xsl:value-of select="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/town"/>
                                                        </fo:block>
                                                      </fo:table-cell>
                                                    </fo:table-row>
                                                    <fo:table-row>
                                                      ...
                                                      <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                        <fo:block>
                                                          <xsl:value-of select="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/region"/>
                                                        </fo:block>
                                                      </fo:table-cell>
                                                    </fo:table-row>
                                                    <fo:table-row>
                                                      ...
                                                      <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                        <fo:block>
                                                          <xsl:value-of select="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country"/>
                                                          <fo:block>
                                                            <xsl:choose>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='PR'">
                                                                <fo:block>Puerto Rico</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='PS'">
                                                                <fo:block>Palestine, State of</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='PT'">
                                                                <fo:block>Portugal</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='PW'">
                                                                <fo:block>Palau</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='PY'">
                                                                <fo:block>Paraguay</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='QA'">
                                                                <fo:block>Qatar</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='PCHH'">
                                                                <fo:block>Pacific Islands, Trust Territory of the</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='AD'">
                                                                <fo:block>Andorra</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='AE'">
                                                                <fo:block>United Arab Emirates</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='AF'">
                                                                <fo:block>Afghanistan</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='AG'">
                                                                <fo:block>Antigua and Barbuda</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='AI'">
                                                                <fo:block>Anguilla</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='AL'">
                                                                <fo:block>Albania</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='AM'">
                                                                <fo:block>Armenia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='AO'">
                                                                <fo:block>Angola</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='AQ'">
                                                                <fo:block>Antarctica</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='AR'">
                                                                <fo:block>Argentina</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='AS'">
                                                                <fo:block>American Samoa</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='AT'">
                                                                <fo:block>Austria</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='RE'">
                                                                <fo:block>Réunion</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='AU'">
                                                                <fo:block>Australia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='AW'">
                                                                <fo:block>Aruba</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='AX'">
                                                                <fo:block>Aland Islands</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='AZ'">
                                                                <fo:block>Azerbaijan</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='RO'">
                                                                <fo:block>Romania</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BA'">
                                                                <fo:block>Bosnia and Herzegovina</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BB'">
                                                                <fo:block>Barbados</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='RS'">
                                                                <fo:block>Serbia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BD'">
                                                                <fo:block>Bangladesh</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BE'">
                                                                <fo:block>Belgium</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='RU'">
                                                                <fo:block>Russian Federation</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BF'">
                                                                <fo:block>Burkina Faso</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='WKUM'">
                                                                <fo:block>Wake Island</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BG'">
                                                                <fo:block>Bulgaria</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='RW'">
                                                                <fo:block>Rwanda</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BH'">
                                                                <fo:block>Bahrain</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BI'">
                                                                <fo:block>Burundi</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BJ'">
                                                                <fo:block>Benin</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BL'">
                                                                <fo:block>Saint Barthélemy</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BM'">
                                                                <fo:block>Bermuda</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BN'">
                                                                <fo:block>Brunei Darussalam</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BO'">
                                                                <fo:block>Bolivia, Plurinational State of</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SA'">
                                                                <fo:block>Saudi Arabia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BQ'">
                                                                <fo:block>Bonaire, Sint Eustatius and Saba</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SB'">
                                                                <fo:block>Solomon Islands</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BR'">
                                                                <fo:block>Brazil</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SC'">
                                                                <fo:block>Seychelles</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BS'">
                                                                <fo:block>Bahamas</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SD'">
                                                                <fo:block>Sudan</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SE'">
                                                                <fo:block>Sweden</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BT'">
                                                                <fo:block>Bhutan</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BV'">
                                                                <fo:block>Bouvet Island</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SG'">
                                                                <fo:block>Singapore</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BW'">
                                                                <fo:block>Botswana</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SH'">
                                                                <fo:block>Saint Helena, Ascension and Tristan da Cunha</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SI'">
                                                                <fo:block>Slovenia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BY'">
                                                                <fo:block>Belarus</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SJ'">
                                                                <fo:block>Svalbard and Jan Mayen</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SK'">
                                                                <fo:block>Slovakia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BZ'">
                                                                <fo:block>Belize</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SL'">
                                                                <fo:block>Sierra Leone</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SM'">
                                                                <fo:block>San Marino</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SN'">
                                                                <fo:block>Senegal</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SO'">
                                                                <fo:block>Somalia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CA'">
                                                                <fo:block>Canada</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SR'">
                                                                <fo:block>Suriname</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CC'">
                                                                <fo:block>Cocos (Keeling) Islands</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SS'">
                                                                <fo:block>South Sudan</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CD'">
                                                                <fo:block>Congo, the Democratic Republic of the</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='ST'">
                                                                <fo:block>Sao Tome and Principe</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CF'">
                                                                <fo:block>Central African Republic</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SV'">
                                                                <fo:block>El Salvador</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CG'">
                                                                <fo:block>Congo</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CH'">
                                                                <fo:block>Switzerland</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SX'">
                                                                <fo:block>Sint Maarten (Dutch part)</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CI'">
                                                                <fo:block>Côte d'Ivoire</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SY'">
                                                                <fo:block>Syrian Arab Republic</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SZ'">
                                                                <fo:block>Swaziland</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CK'">
                                                                <fo:block>Cook Islands</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CL'">
                                                                <fo:block>Chile</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CM'">
                                                                <fo:block>Cameroon</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CN'">
                                                                <fo:block>China</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CO'">
                                                                <fo:block>Colombia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CR'">
                                                                <fo:block>Costa Rica</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='TC'">
                                                                <fo:block>Turks and Caicos Islands</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='TD'">
                                                                <fo:block>Chad</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CU'">
                                                                <fo:block>Cuba</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='TF'">
                                                                <fo:block>French Southern Territories</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CV'">
                                                                <fo:block>Cape Verde</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='TG'">
                                                                <fo:block>Togo</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CW'">
                                                                <fo:block>Curaçao</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='TH'">
                                                                <fo:block>Thailand</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CX'">
                                                                <fo:block>Christmas Island</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CY'">
                                                                <fo:block>Cyprus</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='TJ'">
                                                                <fo:block>Tajikistan</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CZ'">
                                                                <fo:block>Czech Republic</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='TK'">
                                                                <fo:block>Tokelau</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='TL'">
                                                                <fo:block>Timor-Leste</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='TM'">
                                                                <fo:block>Turkmenistan</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='TN'">
                                                                <fo:block>Tunisia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='TO'">
                                                                <fo:block>Tonga</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='TR'">
                                                                <fo:block>Turkey</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='GEHH'">
                                                                <fo:block>Gilbert and Ellice Islands</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='TT'">
                                                                <fo:block>Trinidad and Tobago</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='DE'">
                                                                <fo:block>Germany</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='TV'">
                                                                <fo:block>Tuvalu</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='TW'">
                                                                <fo:block>Taiwan, Province of China</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='DJ'">
                                                                <fo:block>Djibouti</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='TZ'">
                                                                <fo:block>Tanzania, United Republic of</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='DK'">
                                                                <fo:block>Denmark</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='DM'">
                                                                <fo:block>Dominica</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='DO'">
                                                                <fo:block>Dominican Republic</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='UA'">
                                                                <fo:block>Ukraine</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='UG'">
                                                                <fo:block>Uganda</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='UK'">
                                                                <fo:block>United Kingdom</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='DZ'">
                                                                <fo:block>Algeria</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='UM'">
                                                                <fo:block>United States Minor Outlying Islands</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='EC'">
                                                                <fo:block>Ecuador</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='US'">
                                                                <fo:block>United States of America</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='EE'">
                                                                <fo:block>Estonia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BQAQ'">
                                                                <fo:block>British Antarctic Territory</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='EG'">
                                                                <fo:block>Egypt</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='EH'">
                                                                <fo:block>Western Sahara</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='UY'">
                                                                <fo:block>Uruguay</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='UZ'">
                                                                <fo:block>Uzbekistan</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='YUCS'">
                                                                <fo:block>Yugoslavia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='EL'">
                                                                <fo:block>Greece</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BYAA'">
                                                                <fo:block>Byelorussian SSR</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='VA'">
                                                                <fo:block>Holy See</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='ER'">
                                                                <fo:block>Eritrea</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='VC'">
                                                                <fo:block>Saint Vincent and the Grenadines</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='ES'">
                                                                <fo:block>Spain</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='ET'">
                                                                <fo:block>Ethiopia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='VE'">
                                                                <fo:block>Venezuela, Bolivarian Republic of</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='AIDJ'">
                                                                <fo:block>French Afar and Issas</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='VG'">
                                                                <fo:block>Virgin Islands, British</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='VI'">
                                                                <fo:block>Virgin Islands, U.S.</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='VN'">
                                                                <fo:block>Viet Nam</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='VU'">
                                                                <fo:block>Vanuatu</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='FI'">
                                                                <fo:block>Finland</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='FJ'">
                                                                <fo:block>Fiji</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='FK'">
                                                                <fo:block>Falkland Islands (Malvinas)</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SUHH'">
                                                                <fo:block>USSR</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='FM'">
                                                                <fo:block>Micronesia, Federated States of</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='FO'">
                                                                <fo:block>Faroe Islands</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='FR'">
                                                                <fo:block>France</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='WF'">
                                                                <fo:block>Wallis and Futuna</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='GA'">
                                                                <fo:block>Gabon</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='WS'">
                                                                <fo:block>Samoa</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='GD'">
                                                                <fo:block>Grenada</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='GE'">
                                                                <fo:block>Georgia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='GF'">
                                                                <fo:block>French Guiana</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='GG'">
                                                                <fo:block>Guernsey</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='GH'">
                                                                <fo:block>Ghana</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='GI'">
                                                                <fo:block>Gibraltar</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='GL'">
                                                                <fo:block>Greenland</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='GM'">
                                                                <fo:block>Gambia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='GN'">
                                                                <fo:block>Guinea</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='GP'">
                                                                <fo:block>Guadeloupe</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='GQ'">
                                                                <fo:block>Equatorial Guinea</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='GS'">
                                                                <fo:block>South Georgia and the South Sandwich Islands</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='GT'">
                                                                <fo:block>Guatemala</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='GU'">
                                                                <fo:block>Guam</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='GW'">
                                                                <fo:block>Guinea-Bissau</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='GY'">
                                                                <fo:block>Guyana</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='XK'">
                                                                <fo:block>Kosovo</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='HK'">
                                                                <fo:block>Hong Kong</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='HM'">
                                                                <fo:block>Heard Island and McDonald Islands</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='HN'">
                                                                <fo:block>Honduras</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='HR'">
                                                                <fo:block>Croatia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='HT'">
                                                                <fo:block>Haiti</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='YE'">
                                                                <fo:block>Yemen</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='HU'">
                                                                <fo:block>Hungary</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MIUM'">
                                                                <fo:block>Midway Islands</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='NQAQ'">
                                                                <fo:block>Dronning Maud Land</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='ID'">
                                                                <fo:block>Indonesia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='YT'">
                                                                <fo:block>Mayotte</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='IE'">
                                                                <fo:block>Ireland</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='DDDE'">
                                                                <fo:block>German Democratic Republic</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='IL'">
                                                                <fo:block>Israel</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='IM'">
                                                                <fo:block>Isle of Man</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='IN'">
                                                                <fo:block>India</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='IO'">
                                                                <fo:block>British Indian Ocean Territory</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='ZA'">
                                                                <fo:block>South Africa</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='IQ'">
                                                                <fo:block>Iraq</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='IR'">
                                                                <fo:block>Iran, Islamic Republic of</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='IS'">
                                                                <fo:block>Iceland</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='FQHH'">
                                                                <fo:block>French Southern and Antarctic Territories</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='IT'">
                                                                <fo:block>Italy</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='BUMM'">
                                                                <fo:block>Burma</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='ZM'">
                                                                <fo:block>Zambia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='JE'">
                                                                <fo:block>Jersey</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='ZW'">
                                                                <fo:block>Zimbabwe</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='FXFR'">
                                                                <fo:block>France, Metropolitan</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='JTUM'">
                                                                <fo:block>Johnston Island</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='JM'">
                                                                <fo:block>Jamaica</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='JO'">
                                                                <fo:block>Jordan</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='JP'">
                                                                <fo:block>Japan</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='KE'">
                                                                <fo:block>Kenya</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='SKIN'">
                                                                <fo:block>Sikkim</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='KG'">
                                                                <fo:block>Kyrgyzstan</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='KH'">
                                                                <fo:block>Cambodia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='KI'">
                                                                <fo:block>Kiribati</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='PZPA'">
                                                                <fo:block>Panama Canal Zone</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='KM'">
                                                                <fo:block>Comoros</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='NTHH'">
                                                                <fo:block>Neutral Zone</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='KN'">
                                                                <fo:block>Saint Kitts and Nevis</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='KP'">
                                                                <fo:block>Korea, Democratic People's Republic of</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='KR'">
                                                                <fo:block>Korea, Republic of</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='KW'">
                                                                <fo:block>Kuwait</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='KY'">
                                                                <fo:block>Cayman Islands</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='KZ'">
                                                                <fo:block>Kazakhstan</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CSHH'">
                                                                <fo:block>Czechoslovakia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CSXX'">
                                                                <fo:block>Serbia and Montenegro</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='LA'">
                                                                <fo:block>Lao People's Democratic Republic</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='LB'">
                                                                <fo:block>Lebanon</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='LC'">
                                                                <fo:block>Saint Lucia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='PUUM'">
                                                                <fo:block>Us Miscellaneous Pacific Islands</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='LI'">
                                                                <fo:block>Liechtenstein</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='YDYE'">
                                                                <fo:block>Yemen, Democratic</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='LK'">
                                                                <fo:block>Sri Lanka</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='LR'">
                                                                <fo:block>Liberia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='LS'">
                                                                <fo:block>Lesotho</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='LT'">
                                                                <fo:block>Lithuania</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='LU'">
                                                                <fo:block>Luxembourg</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='LV'">
                                                                <fo:block>Latvia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='LY'">
                                                                <fo:block>Libya</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='CTKI'">
                                                                <fo:block>Canton and Enderbury Islands</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MA'">
                                                                <fo:block>Morocco</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MC'">
                                                                <fo:block>Monaco</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MD'">
                                                                <fo:block>Moldova, Republic of</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='ME'">
                                                                <fo:block>Montenegro</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MF'">
                                                                <fo:block>Saint Martin (French part)</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MG'">
                                                                <fo:block>Madagascar</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MH'">
                                                                <fo:block>Marshall Islands</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MK'">
                                                                <fo:block>Macedonia, the former Yugoslav Republic of</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='ML'">
                                                                <fo:block>Mali</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MM'">
                                                                <fo:block>Myanmar</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MN'">
                                                                <fo:block>Mongolia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MO'">
                                                                <fo:block>Macao</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MP'">
                                                                <fo:block>Northern Mariana Islands</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MQ'">
                                                                <fo:block>Martinique</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MR'">
                                                                <fo:block>Mauritania</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MS'">
                                                                <fo:block>Montserrat</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MT'">
                                                                <fo:block>Malta</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MU'">
                                                                <fo:block>Mauritius</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MV'">
                                                                <fo:block>Maldives</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MW'">
                                                                <fo:block>Malawi</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MX'">
                                                                <fo:block>Mexico</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MY'">
                                                                <fo:block>Malaysia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='MZ'">
                                                                <fo:block>Mozambique</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='NA'">
                                                                <fo:block>Namibia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='ZRCD'">
                                                                <fo:block>Zaire</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='NC'">
                                                                <fo:block>New Caledonia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='NE'">
                                                                <fo:block>Niger</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='NF'">
                                                                <fo:block>Norfolk Island</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='NG'">
                                                                <fo:block>Nigeria</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='NI'">
                                                                <fo:block>Nicaragua</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='DYBJ'">
                                                                <fo:block>Dahomey</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='NL'">
                                                                <fo:block>Netherlands (the)</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='NO'">
                                                                <fo:block>Norway</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='NP'">
                                                                <fo:block>Nepal</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='NR'">
                                                                <fo:block>Nauru</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='NU'">
                                                                <fo:block>Niue</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='NZ'">
                                                                <fo:block>New Zealand</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='VDVN'">
                                                                <fo:block>Viet-Nam, Democratic Republic of</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='TPTL'">
                                                                <fo:block>East Timor</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='RHZW'">
                                                                <fo:block>Southern Rhodesia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='NHVU'">
                                                                <fo:block>New Hebrides</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='OM'">
                                                                <fo:block>Oman</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='HVBF'">
                                                                <fo:block>Upper Volta</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='PA'">
                                                                <fo:block>Panama</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='ANHH'">
                                                                <fo:block>Netherlands Antilles</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='PE'">
                                                                <fo:block>Peru</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='PF'">
                                                                <fo:block>French Polynesia</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='PG'">
                                                                <fo:block>Papua New Guinea</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='PH'">
                                                                <fo:block>Philippines</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='PK'">
                                                                <fo:block>Pakistan</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='PL'">
                                                                <fo:block>Poland</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='PM'">
                                                                <fo:block>Saint Pierre and Miquelon</fo:block>
                                                              </xsl:when>
                                                              <xsl:when test="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/PlaceBirth/country/value='PN'">
                                                                <fo:block>Pitcairn</fo:block>
                                                              </xsl:when>
                                                              <xsl:otherwise>
                                                                <fo:block>-/-</fo:block>
                                        ...
                                        <fo:table-row>
                                          ...
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/fatherFamilyNameAtBirth"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                        <fo:table-row>
                                          ...
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/forenameFather"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                        <fo:table-row>
                                          ...
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/motherFamilyNameAtBirth"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                        <fo:table-row>
                                          ...
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//PleaseFillInIfThisDocumentConcernsFamilyMember/InsuredPerson/IfPINNotProvidedForEveryInstitutionPleaseProvide/forenameMother"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-body>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-body start-indent="2mm">
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">4.1. Document</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//InformationConcerningEntitlementDocument/document"/>
                      <fo:block>
                        <xsl:choose>
                          <xsl:when test="//InformationConcerningEntitlementDocument/document/value='01'">
                            <fo:block>Portable Document S1</fo:block>
                          </xsl:when>
                          <xsl:when test="//InformationConcerningEntitlementDocument/document/value='02'">
                            <fo:block>SED S072</fo:block>
                          </xsl:when>
                          <xsl:when test="//InformationConcerningEntitlementDocument/document/value='03'">
                            <fo:block>E106</fo:block>
                          </xsl:when>
                          <xsl:when test="//InformationConcerningEntitlementDocument/document/value='04'">
                            <fo:block>E109</fo:block>
                          </xsl:when>
                          <xsl:when test="//InformationConcerningEntitlementDocument/document/value='05'">
                            <fo:block>E120</fo:block>
                          </xsl:when>
                          <xsl:when test="//InformationConcerningEntitlementDocument/document/value='06'">
                ...
                <fo:table-row>
                  ...
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//InformationConcerningEntitlementDocument/issuedOn"/>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-header background-color="LightGrey">
                            <fo:table-row border="solid 0.2mm Grey">
                              <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                <fo:block>4.3. Period of entitlement document</fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-header>
                          <fo:table-body start-indent="2mm">
                                    ...
                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                      ...
                                      <fo:table-body start-indent="2mm">
                                        <fo:table-row>
                                          ...
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//InformationConcerningEntitlementDocument/PeriodEntitlementDocument/FixedPeriod/startDate"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                        <fo:table-row>
                                          ...
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//InformationConcerningEntitlementDocument/PeriodEntitlementDocument/FixedPeriod/endDate"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-body>
                                    ...
                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                      ...
                                      <fo:table-body start-indent="2mm">
                                        <fo:table-row>
                                          ...
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//InformationConcerningEntitlementDocument/PeriodEntitlementDocument/OpenPeriod/typeOpenPeriod"/>
                                              <fo:block>
                                                <xsl:choose>
                                                  <xsl:when test="//InformationConcerningEntitlementDocument/PeriodEntitlementDocument/OpenPeriod/typeOpenPeriod/value='01'">
                                                    <fo:block>Open-Ended Period</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationConcerningEntitlementDocument/PeriodEntitlementDocument/OpenPeriod/typeOpenPeriod/value='98'">
                                        ...
                                        <fo:table-row>
                                          ...
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//InformationConcerningEntitlementDocument/PeriodEntitlementDocument/OpenPeriod/startDate"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-body>
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-body start-indent="2mm">
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">5.1.1. End date of Registration</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//Cancellation/WithEndDate/endDateRegistration"/>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
                                  ...
                                  <fo:block>
                                    <xsl:choose>
                                      ...
                                      <xsl:when test="//Cancellation/WithEndDate/reason/value='01'">
                                        <fo:block>Insured in our Member State since</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//Cancellation/WithEndDate/reason/value='02'">
                                        <fo:block>Insured in another Member State since</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//Cancellation/WithEndDate/reason/value='03'">
                                        <fo:block>No longer resides in our Member State since</fo:block>
                                      </xsl:when>
                                      ...
                                      <xsl:when test="//Cancellation/WithEndDate/reason/value='07'">
                                        <fo:block>Change of institution within our Member State. You will shortly receive a new SED S073 indicating the ID of the institution of the country of residence.</fo:block>
                                      </xsl:when>
                                      <xsl:otherwise>
                                        <fo:block>-/-</fo:block>
                                      </xsl:otherwise>
                                  ...
                                  <fo:block>
                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                      ...
                                      <fo:table-header background-color="LightGrey">
                                        <fo:table-row border="solid 0.2mm Grey">
                                          <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>5.1.3. Please fill in the following if \Reason\ = \Insured in our Member State since\ OR \Reason\ = \No longer resides in our member state since\ :</fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-header>
                                      <fo:table-body start-indent="2mm">
                                        <fo:table-row>
                                          ...
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInOurMemberState/date"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-body>
                                    ...
                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                      ...
                                      <fo:table-body start-indent="2mm">
                                        <fo:table-row>
                                          ...
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//Cancellation/WithEndDate/PleaseFillInFollowingIfReasonDiedOn/diedOn"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-body>
                                  ...
                                  <fo:block>
                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                      ...
                                      <fo:table-header background-color="LightGrey">
                                        <fo:table-row border="solid 0.2mm Grey">
                                          <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>5.1.5. Please fill in the following if \Reason\ = \Insured in another Member State since\</fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-header>
                                      <fo:table-body start-indent="2mm">
                                        <fo:table-row>
                                          ...
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance"/>
                                              <fo:block>
                                                <xsl:choose>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='DE'">
                                                    <fo:block>Germany</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='NO'">
                                                    <fo:block>Norway</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='BE'">
                                                    <fo:block>Belgium</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='FI'">
                                                    <fo:block>Finland</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='PT'">
                                                    <fo:block>Portugal</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='BG'">
                                                    <fo:block>Bulgaria</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='DK'">
                                                    <fo:block>Denmark</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='LT'">
                                                    <fo:block>Lithuania</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='LU'">
                                                    <fo:block>Luxembourg</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='HR'">
                                                    <fo:block>Croatia</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='LV'">
                                                    <fo:block>Latvia</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='FR'">
                                                    <fo:block>France</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='HU'">
                                                    <fo:block>Hungary</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='SE'">
                                                    <fo:block>Sweden</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='SI'">
                                                    <fo:block>Slovenia</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='UK'">
                                                    <fo:block>United Kingdom</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='SK'">
                                                    <fo:block>Slovakia</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='IE'">
                                                    <fo:block>Ireland</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='EE'">
                                                    <fo:block>Estonia</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='CH'">
                                                    <fo:block>Switzerland</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='EL'">
                                                    <fo:block>Greece</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='MT'">
                                                    <fo:block>Malta</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='IS'">
                                                    <fo:block>Iceland</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='IT'">
                                                    <fo:block>Italy</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='ES'">
                                                    <fo:block>Spain</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='AT'">
                                                    <fo:block>Austria</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='CY'">
                                                    <fo:block>Cyprus</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='CZ'">
                                                    <fo:block>Czechia</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='PL'">
                                                    <fo:block>Poland</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='LI'">
                                                    <fo:block>Liechtenstein</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='RO'">
                                                    <fo:block>Romania</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/iSOCodeCountryInsurance/value='NL'">
                                                    <fo:block>Netherlands</fo:block>
                                                  </xsl:when>
                                                  <xsl:otherwise>
                                                    <fo:block>-/-</fo:block>
                                        ...
                                        <fo:table-row>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block wrap-option="wrap">5.1.5.2. Date</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//Cancellation/WithEndDate/PleaseFillInIfReasonInsuredInAnotherMemberState/date"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-body>
                                  ...
                                  <fo:block>
                                    <xsl:choose>
                                      ...
                                      <xsl:when test="//Cancellation/InFull/reason/value='01'">
                                        <fo:block>The entitlement was registered by mistake</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//Cancellation/InFull/reason/value='02'">
                                        <fo:block>The person has not resided in our MS</fo:block>
                                      </xsl:when>
                                      <xsl:otherwise>
                                        <fo:block>-/-</fo:block>
                                      </xsl:otherwise>
