...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
  <xsl:variable name="filename">XSD2PDF_S068_de-DE_4.4.1_6.0.1.xslt</xsl:variable>
    ...
    <fo:root font-family="Arial Unicode MS" font-size="10pt">
      ...
      <fo:page-sequence master-reference="Standard">
        <fo:static-content flow-name="xsl-region-before">
          <fo:table table-layout="fixed" width="100%" margin="5mm 0mm 0mm 0mm">
            ...
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="14pt" text-align="start">S068 - Antwort auf Auskunftsersuchen zu Erstattungssätzen - Aufenthalt</fo:block>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="8pt" text-align="start">S068 - Reply reimbursement rates - stay</fo:block>
                </fo:table-cell>
                <fo:table-cell>
        ...
        <fo:flow flow-name="xsl-region-body">
          <fo:block font-family="Arial Unicode MS" font-size="10pt">Artikel 19, 20 und 27 der Verordnung (EG) Nr. 883/2004; Artikel 25 und 26 der Verordnung (EG) Nr. 987/2009</fo:block>
          <fo:block>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>2. Information über Erstattungssätze</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">2.1. Art der Behandlung</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//InformationReimbursementRates/typeTreatment"/>
                      <fo:block>
                        <xsl:choose>
                          <xsl:when test="//InformationReimbursementRates/typeTreatment/value='01'">
                            <fo:block>Notwendige Behandlung</fo:block>
                          </xsl:when>
                          <xsl:when test="//InformationReimbursementRates/typeTreatment/value='02'">
                            <fo:block>Geplante Behandlung</fo:block>
                          </xsl:when>
                          <xsl:otherwise>
                            <fo:block>-/-</fo:block>
                          </xsl:otherwise>
                ...
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">2.2. Erstattung</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//InformationReimbursementRates/reimbursementIndicator"/>
                      <fo:block>
                        <xsl:choose>
                          <xsl:when test="//InformationReimbursementRates/reimbursementIndicator/value='0'">
                            <fo:block>Nein</fo:block>
                          </xsl:when>
                          <xsl:when test="//InformationReimbursementRates/reimbursementIndicator/value='1'">
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-header background-color="LightGrey">
                            <fo:table-row border="solid 0.2mm Grey">
                              <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                <fo:block>2.3. Füllen Sie bitte folgendes Feld aus, wenn „Erstattung“ = „Ja“:</fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-header>
                          <fo:table-body start-indent="2mm">
                                  ...
                                  <fo:block>
                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                      ...
                                      <fo:table-header background-color="LightGrey">
                                        <fo:table-row border="solid 0.2mm Grey">
                                          <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>2.3.1. Kosten der Behandlung</fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-header>
                                      <fo:table-body start-indent="2mm">
                                        <fo:table-row>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block wrap-option="wrap">2.3.1.1. Betrag</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//InformationReimbursementRates/FillInIfInformationReimbursement/CostTreatment/amount"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                        <fo:table-row>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block wrap-option="wrap">2.3.1.2. Währung</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//InformationReimbursementRates/FillInIfInformationReimbursement/CostTreatment/currency"/>
                                              <fo:block>
                                                <xsl:choose>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/CostTreatment/currency/value='HRK'">
                                                    <fo:block>Kroatische Kuna</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/CostTreatment/currency/value='CHF'">
                                                    <fo:block>Schweizer Franken</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/CostTreatment/currency/value='ISK'">
                                                    <fo:block>Isländische Krone</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/CostTreatment/currency/value='EUR'">
                                                    <fo:block>Euro</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/CostTreatment/currency/value='LVL'">
                                                    <fo:block>lettische Lats</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/CostTreatment/currency/value='DKK'">
                                                    <fo:block>Dänische Krone</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/CostTreatment/currency/value='LTL'">
                                                    <fo:block>litauische Litas</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/CostTreatment/currency/value='BGN'">
                                                    <fo:block>Bulgarischer Lew</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/CostTreatment/currency/value='NOK'">
                                                    <fo:block>Norwegische Krone</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/CostTreatment/currency/value='RON'">
                                                    <fo:block>Rumänischer Leu</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/CostTreatment/currency/value='PLN'">
                                                    <fo:block>Polnischer Zloty</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/CostTreatment/currency/value='GBP'">
                                                    <fo:block>Britisches Pfund</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/CostTreatment/currency/value='CZK'">
                                                    <fo:block>Tschechische Krone</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/CostTreatment/currency/value='HUF'">
                                                    <fo:block>Ungarischer Forint</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/CostTreatment/currency/value='SEK'">
                                  ...
                                  <fo:block>
                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                      ...
                                      <fo:table-header background-color="LightGrey">
                                        <fo:table-row border="solid 0.2mm Grey">
                                          <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>2.3.2. Zu erstattender Betrag</fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-header>
                                      <fo:table-body start-indent="2mm">
                                        <fo:table-row>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block wrap-option="wrap">2.3.2.1. Betrag</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//InformationReimbursementRates/FillInIfInformationReimbursement/AmountReimbursed/amount"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                        <fo:table-row>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block wrap-option="wrap">2.3.2.2. Währung</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//InformationReimbursementRates/FillInIfInformationReimbursement/AmountReimbursed/currency"/>
                                              <fo:block>
                                                <xsl:choose>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/AmountReimbursed/currency/value='HRK'">
                                                    <fo:block>Kroatische Kuna</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/AmountReimbursed/currency/value='CHF'">
                                                    <fo:block>Schweizer Franken</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/AmountReimbursed/currency/value='ISK'">
                                                    <fo:block>Isländische Krone</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/AmountReimbursed/currency/value='EUR'">
                                                    <fo:block>Euro</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/AmountReimbursed/currency/value='LVL'">
                                                    <fo:block>lettische Lats</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/AmountReimbursed/currency/value='DKK'">
                                                    <fo:block>Dänische Krone</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/AmountReimbursed/currency/value='LTL'">
                                                    <fo:block>litauische Litas</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/AmountReimbursed/currency/value='BGN'">
                                                    <fo:block>Bulgarischer Lew</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/AmountReimbursed/currency/value='NOK'">
                                                    <fo:block>Norwegische Krone</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/AmountReimbursed/currency/value='RON'">
                                                    <fo:block>Rumänischer Leu</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/AmountReimbursed/currency/value='PLN'">
                                                    <fo:block>Polnischer Zloty</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/AmountReimbursed/currency/value='GBP'">
                                                    <fo:block>Britisches Pfund</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/AmountReimbursed/currency/value='CZK'">
                                                    <fo:block>Tschechische Krone</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/AmountReimbursed/currency/value='HUF'">
                                                    <fo:block>Ungarischer Forint</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//InformationReimbursementRates/FillInIfInformationReimbursement/AmountReimbursed/currency/value='SEK'">
                                                    <fo:block>Schwedische Krone</fo:block>
                                                  </xsl:when>
                                                  <xsl:otherwise>
                                                    <fo:block>-/-</fo:block>
                ...
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">2.4. Zusätzliche Informationen</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//InformationReimbursementRates/additionalInformation"/>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-body>
