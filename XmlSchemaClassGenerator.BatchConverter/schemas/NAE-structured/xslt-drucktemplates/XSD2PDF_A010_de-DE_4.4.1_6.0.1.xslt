...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:fo="http://www.w3.org/1999/XSL/Format" version="1.0">
  <xsl:variable name="filename">XSD2PDF_A010_de-DE_4.4.1_6.0.1.xslt</xsl:variable>
    ...
    <fo:root font-family="Arial Unicode MS" font-size="10pt">
      ...
      <fo:page-sequence master-reference="Standard">
        <fo:static-content flow-name="xsl-region-before">
          <fo:table table-layout="fixed" width="100%" margin="5mm 0mm 0mm 0mm">
            ...
            <fo:table-body>
              <fo:table-row>
                <fo:table-cell>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="14pt" text-align="start">A010 - Mitteilung über die anwendbaren Rechtsvorschriften</fo:block>
                  <fo:block font-family="Arial Unicode MS" margin-left="5mm" font-size="8pt" text-align="start">A010 - Notification of Applicable Legislation</fo:block>
                </fo:table-cell>
                <fo:table-cell>
        ...
        <fo:flow flow-name="xsl-region-body">
          <fo:block font-family="Arial Unicode MS" font-size="10pt">Artikel 11 Absatz 3 Buchstaben b, c und d, Artikel 11 Absätze 4 und 5, Artikel 15 der Verordnung (EG) Nr. 883/2004 und Artikel 15 und 17 der Verordnung (EG) Nr. 987/2009</fo:block>
          <fo:block>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>3. Anschriften</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                                    ...
                                    <fo:block>
                                      <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                        ...
                                        <fo:table-body start-indent="2mm">
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">3.1.2.1.[
                                          ...
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">3.1.2.2.[
                                          ...
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">3.1.2.3.[
                                          ...
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">3.1.2.4.[
                                          ...
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">3.1.2.5.[
                                          ...
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">3.1.2.6.[
                                                <xsl:value-of select="position()"/>] Land
                                              </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                ...
                <xsl:if test="not(//Addresses/Address)">
                  <fo:table-row>
                    <fo:table-cell number-columns-spanned="2">
                      <fo:block/>
                    </fo:table-cell>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>4. Arbeitgeber/in(nen) im Entsendestaat</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                <xsl:for-each select="//EmployerInPostingState/Employer">
                  <fo:table-row>
                    <fo:table-cell number-columns-spanned="2">
                      <fo:block>
                        <fo:block>
                          <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                            ...
                            <fo:table-body start-indent="2mm">
                              <fo:table-row>
                                <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                  <fo:block wrap-option="wrap">4.1.1.[
                                                  ...
                                                  <fo:block>
                                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                                      ...
                                                      <fo:table-body start-indent="2mm">
                                                        <fo:table-row>
                                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                            <fo:block wrap-option="wrap">4.1.2.1.1.[
                                                        ...
                                                        <fo:table-row>
                                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                            <fo:block wrap-option="wrap">4.1.2.1.2.[
                                                              <xsl:value-of select="position()"/>] Art
                                                            </fo:block>
                                                          </fo:table-cell>
                                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                    ...
                                    <fo:block>
                                      <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                        ...
                                        <fo:table-body start-indent="2mm">
                                          ...
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">4.1.3.2.[
                                                <xsl:value-of select="position()"/>] Gebäudename/-bezeichnung
                                              </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                          ...
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">4.1.3.3.[
                                                <xsl:value-of select="position()"/>] Ort
                                              </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                          ...
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">4.1.3.4.[
                                                <xsl:value-of select="position()"/>] Postleitzahl
                                              </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                          ...
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">4.1.3.5.[
                                                <xsl:value-of select="position()"/>] Region
                                              </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                          ...
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">4.1.3.6.[
                                                <xsl:value-of select="position()"/>] Land
                                              </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                ...
                <xsl:if test="not(//EmployerInPostingState/Employer)">
                  <fo:table-row>
                    <fo:table-cell number-columns-spanned="2">
                      <fo:block/>
                    </fo:table-cell>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>5. Arbeitgeber/in(nen) in anderen beteiligten Mitgliedstaaten</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                <xsl:for-each select="//EmployerInOtherMSConcerned/Employer">
                  <fo:table-row>
                    <fo:table-cell number-columns-spanned="2">
                      <fo:block>
                        <fo:block>
                          <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                            ...
                            <fo:table-body start-indent="2mm">
                              <fo:table-row>
                                <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                  <fo:block wrap-option="wrap">5.1.1.[
                                    <xsl:value-of select="position()"/>] Name
                                  </fo:block>
                                </fo:table-cell>
                                <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                  ...
                                                  <fo:block>
                                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                                      ...
                                                      <fo:table-body start-indent="2mm">
                                                        <fo:table-row>
                                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                            <fo:block wrap-option="wrap">5.1.2.1.1.[
                                                              <xsl:value-of select="position()"/>] Nummer
                                                            </fo:block>
                                                          </fo:table-cell>
                                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                        ...
                                                        <fo:table-row>
                                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                            <fo:block wrap-option="wrap">5.1.2.1.2.[
                                                              <xsl:value-of select="position()"/>] Art
                                                            </fo:block>
                                                          </fo:table-cell>
                                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                    ...
                                    <fo:block>
                                      <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                        ...
                                        <fo:table-body start-indent="2mm">
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">5.1.3.1.[
                                                <xsl:value-of select="position()"/>] Straße
                                              </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                          ...
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">5.1.3.2.[
                                                <xsl:value-of select="position()"/>] Gebäudename/-bezeichnung
                                              </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                          ...
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">5.1.3.3.[
                                                <xsl:value-of select="position()"/>] Ort
                                              </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                          ...
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">5.1.3.4.[
                                                <xsl:value-of select="position()"/>] Postleitzahl
                                              </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                          ...
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">5.1.3.5.[
                                                <xsl:value-of select="position()"/>] Region
                                              </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                          ...
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">5.1.3.6.[
                                                <xsl:value-of select="position()"/>] Land
                                              </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                ...
                <xsl:if test="not(//EmployerInOtherMSConcerned/Employer)">
                  <fo:table-row>
                    <fo:table-cell number-columns-spanned="2">
                      <fo:block/>
                    </fo:table-cell>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>6. Selbstständige Erwerbstätigkeit(en)</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                <xsl:for-each select="//SelfEmployment/SelfEmployment">
                  <fo:table-row>
                    <fo:table-cell number-columns-spanned="2">
                      <fo:block>
                        <fo:block>
                          <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                            ...
                            <fo:table-body start-indent="2mm">
                              <fo:table-row>
                                <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                  <fo:block wrap-option="wrap">6.1.1.[
                                    <xsl:value-of select="position()"/>] Name
                                  </fo:block>
                                </fo:table-cell>
                                <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                  ...
                                                  <fo:block>
                                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                                      ...
                                                      <fo:table-body start-indent="2mm">
                                                        <fo:table-row>
                                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                            <fo:block wrap-option="wrap">6.1.2.1.1.[
                                                              <xsl:value-of select="position()"/>] Nummer
                                                            </fo:block>
                                                          </fo:table-cell>
                                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                        ...
                                                        <fo:table-row>
                                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                            <fo:block wrap-option="wrap">6.1.2.1.2.[
                                                              <xsl:value-of select="position()"/>] Art
                                                            </fo:block>
                                                          </fo:table-cell>
                                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                    ...
                                    <fo:block>
                                      <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                        ...
                                        <fo:table-body start-indent="2mm">
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">6.1.3.1.[
                                                <xsl:value-of select="position()"/>] Straße
                                              </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                          ...
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">6.1.3.2.[
                                                <xsl:value-of select="position()"/>] Gebäudename/-bezeichnung
                                              </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                          ...
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">6.1.3.3.[
                                                <xsl:value-of select="position()"/>] Ort
                                              </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                          ...
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">6.1.3.4.[
                                                <xsl:value-of select="position()"/>] Postleitzahl
                                              </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                          ...
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">6.1.3.5.[
                                                <xsl:value-of select="position()"/>] Region
                                              </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                          ...
                                          <fo:table-row>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                              <fo:block wrap-option="wrap">6.1.3.6.[
                                                <xsl:value-of select="position()"/>] Land
                                              </fo:block>
                                            </fo:table-cell>
                                            <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                ...
                <xsl:if test="not(//SelfEmployment/SelfEmployment)">
                  <fo:table-row>
                    <fo:table-cell number-columns-spanned="2">
                      <fo:block/>
                    </fo:table-cell>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>7. Arbeitsort(e)</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">7.1. Ein fester Arbeitsort ist vorhanden</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//PlaceWork/aFixedPlaceWorkExistsIndicator"/>
                      <fo:block>
                        <xsl:choose>
                          <xsl:when test="//PlaceWork/aFixedPlaceWorkExistsIndicator/value='0'">
                            <fo:block>Nein</fo:block>
                          </xsl:when>
                          <xsl:when test="//PlaceWork/aFixedPlaceWorkExistsIndicator/value='1'">
                ...
                <xsl:for-each select="//PlaceWork/CountriesWork">
                  <fo:table-row>
                    <fo:table-cell number-columns-spanned="2">
                      <fo:block>
                        <fo:block>
                          <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                            ...
                            <fo:table-body start-indent="2mm">
                              <fo:table-row>
                                <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                  <fo:block wrap-option="wrap">7.2.1.[
                                                  ...
                                                  <fo:block>
                                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                                      ...
                                                      <fo:table-body start-indent="2mm">
                                                        <fo:table-row>
                                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                            <fo:block wrap-option="wrap">7.2.2.1.1.[
                                                        ...
                                                        <fo:table-row>
                                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                            <fo:block wrap-option="wrap">7.2.2.1.2.[
                                                              ...
                                                              <fo:block>
                                                                <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                                                  ...
                                                                  <fo:table-body start-indent="2mm">
                                                                    <fo:table-row>
                                                                      <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                                        <fo:block wrap-option="wrap">7.2.2.1.3.1.[
                                                                          <xsl:value-of select="position()"/>] Straße
                                                                        </fo:block>
                                                                      </fo:table-cell>
                                                                      <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                                    ...
                                                                    <fo:table-row>
                                                                      <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                                        <fo:block wrap-option="wrap">7.2.2.1.3.2.[
                                                                          <xsl:value-of select="position()"/>] Gebäudename/-bezeichnung
                                                                        </fo:block>
                                                                      </fo:table-cell>
                                                                      <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                                    ...
                                                                    <fo:table-row>
                                                                      <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                                        <fo:block wrap-option="wrap">7.2.2.1.3.3.[
                                                                    ...
                                                                    <fo:table-row>
                                                                      <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                                        <fo:block wrap-option="wrap">7.2.2.1.3.4.[
                                                                          <xsl:value-of select="position()"/>] Postleitzahl
                                                                        </fo:block>
                                                                      </fo:table-cell>
                                                                      <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                                    ...
                                                                    <fo:table-row>
                                                                      <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                                                        <fo:block wrap-option="wrap">7.2.2.1.3.5.[
                                                                          <xsl:value-of select="position()"/>] Region
                                                                        </fo:block>
                                                                      </fo:table-cell>
                                                                      <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                ...
                <xsl:if test="not(//PlaceWork/CountriesWork)">
                  <fo:table-row>
                    <fo:table-cell number-columns-spanned="2">
                      <fo:block/>
                    </fo:table-cell>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>8. Entscheidung über die anwendbaren Rechtsvorschriften</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-header background-color="LightGrey">
                            <fo:table-row border="solid 0.2mm Grey">
                              <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                <fo:block>8.1. Entscheidung:</fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-header>
                          <fo:table-body start-indent="2mm">
                            <fo:table-row>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block wrap-option="wrap">8.1.1. Ursprüngliche Entscheidung</fo:block>
                              </fo:table-cell>
                              <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                <fo:block>
                                  <xsl:value-of select="//DecisionLegislationApplicable/Decision/InitialDecision"/>
                                  <fo:block>
                                    <xsl:choose>
                                      <xsl:when test="//DecisionLegislationApplicable/Decision/InitialDecision/value='0'">
                                        <fo:block>Nein</fo:block>
                                      </xsl:when>
                                      <xsl:when test="//DecisionLegislationApplicable/Decision/InitialDecision/value='1'">
                                        <fo:block>Ja</fo:block>
                                      </xsl:when>
                                      <xsl:otherwise>
                                        <fo:block>-/-</fo:block>
                                  ...
                                  <fo:block>
                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                      ...
                                      <fo:table-header background-color="LightGrey">
                                        <fo:table-row border="solid 0.2mm Grey">
                                          <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>8.1.2. Änderung der Entscheidung</fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-header>
                                      <fo:table-body start-indent="2mm">
                                        <fo:table-row>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block wrap-option="wrap">8.1.2.1. Ursprüngliche Entscheidung</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//DecisionLegislationApplicable/Decision/AmendingDecision/InitialDecision"/>
                                              <fo:block>
                                                <xsl:choose>
                                                  <xsl:when test="//DecisionLegislationApplicable/Decision/AmendingDecision/InitialDecision/value='0'">
                                                    <fo:block>Nein</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//DecisionLegislationApplicable/Decision/AmendingDecision/InitialDecision/value='1'">
                                                    <fo:block>Ja</fo:block>
                                                  </xsl:when>
                                                  <xsl:otherwise>
                                                    <fo:block>-/-</fo:block>
                                        ...
                                        <fo:table-row>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block wrap-option="wrap">8.1.2.2. Datum der vorherigen Entscheidung</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//DecisionLegislationApplicable/Decision/AmendingDecision/datePreviousDecision"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-body>
                ...
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">8.2. Mitgliedstaat, dessen Rechtsvorschriften anzuwenden sind</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//DecisionLegislationApplicable/memberStateWhichLegislationApplies"/>
                      <fo:block>
                        <xsl:choose>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='DE'">
                            <fo:block>Deutschland</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='NO'">
                            <fo:block>Norwegen</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='BE'">
                            <fo:block>Belgien</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='FI'">
                            <fo:block>Finnland</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='PT'">
                            <fo:block>Portugal</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='BG'">
                            <fo:block>Bulgarien</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='DK'">
                            <fo:block>Dänemark</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='LT'">
                            <fo:block>Litauen</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='LU'">
                            <fo:block>Luxemburg</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='HR'">
                            <fo:block>Kroatien</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='LV'">
                            <fo:block>Lettland</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='FR'">
                            <fo:block>Frankreich</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='HU'">
                            <fo:block>Ungarn</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='SE'">
                            <fo:block>Schweden</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='SI'">
                            <fo:block>Slowenien</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='UK'">
                            <fo:block>Vereinigtes Königreich</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='SK'">
                            <fo:block>Slowakei</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='IE'">
                            <fo:block>Irland</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='EE'">
                            <fo:block>Estland</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='CH'">
                            <fo:block>Schweiz</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='EL'">
                            <fo:block>Griechenland</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='MT'">
                            <fo:block>Malta</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='IS'">
                            <fo:block>Island</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='IT'">
                            <fo:block>Italien</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='ES'">
                            <fo:block>Spanien</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='AT'">
                            <fo:block>Österreich</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='CY'">
                            <fo:block>Zypern</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='CZ'">
                            <fo:block>Tschechien</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='PL'">
                            <fo:block>Polen</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='LI'">
                            <fo:block>Liechtenstein</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='RO'">
                            <fo:block>Rumänien</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/memberStateWhichLegislationApplies/value='NL'">
                            <fo:block>Niederlande</fo:block>
                          </xsl:when>
                          <xsl:otherwise>
                            <fo:block>-/-</fo:block>
                ...
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">8.3. Die Entscheidung gilt für die Dauer der Tätigkeit</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//DecisionLegislationApplicable/theDecisionAppliesForDurationActivityIndicator"/>
                      <fo:block>
                        <xsl:choose>
                          <xsl:when test="//DecisionLegislationApplicable/theDecisionAppliesForDurationActivityIndicator/value='0'">
                            <fo:block>Nein</fo:block>
                          </xsl:when>
                          <xsl:when test="//DecisionLegislationApplicable/theDecisionAppliesForDurationActivityIndicator/value='1'">
                            <fo:block>Ja</fo:block>
                          </xsl:when>
                          <xsl:otherwise>
                            <fo:block>-/-</fo:block>
                      ...
                      <fo:block>
                        <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                          ...
                          <fo:table-header background-color="LightGrey">
                            <fo:table-row border="solid 0.2mm Grey">
                              <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                <fo:block>8.4. Zeitraum, für den die Entscheidung gilt</fo:block>
                              </fo:table-cell>
                            </fo:table-row>
                          </fo:table-header>
                          <fo:table-body start-indent="2mm">
                                  ...
                                  <fo:block>
                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                      ...
                                      <fo:table-header background-color="LightGrey">
                                        <fo:table-row border="solid 0.2mm Grey">
                                          <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>8.4.1. Feststehender Zeitraum</fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-header>
                                      <fo:table-body start-indent="2mm">
                                        <fo:table-row>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block wrap-option="wrap">8.4.1.1. Datum Beginn</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//DecisionLegislationApplicable/PeriodForWhichDecisionApplies/FixedPeriod/startDate"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                        <fo:table-row>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block wrap-option="wrap">8.4.1.2. Datum Ende</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//DecisionLegislationApplicable/PeriodForWhichDecisionApplies/FixedPeriod/endDate"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-body>
                                  ...
                                  <fo:block>
                                    <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
                                      ...
                                      <fo:table-header background-color="LightGrey">
                                        <fo:table-row border="solid 0.2mm Grey">
                                          <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>8.4.2. Offener Zeitraum</fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-header>
                                      <fo:table-body start-indent="2mm">
                                        <fo:table-row>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block wrap-option="wrap">8.4.2.1. Art des offenen Zeitraums</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//DecisionLegislationApplicable/PeriodForWhichDecisionApplies/OpenPeriod/typeOpenPeriod"/>
                                              <fo:block>
                                                <xsl:choose>
                                                  <xsl:when test="//DecisionLegislationApplicable/PeriodForWhichDecisionApplies/OpenPeriod/typeOpenPeriod/value='01'">
                                                    <fo:block>Unbefristeter Zeitraum</fo:block>
                                                  </xsl:when>
                                                  <xsl:when test="//DecisionLegislationApplicable/PeriodForWhichDecisionApplies/OpenPeriod/typeOpenPeriod/value='98'">
                                        ...
                                        <fo:table-row>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block wrap-option="wrap">8.4.2.2. Datum Beginn</fo:block>
                                          </fo:table-cell>
                                          <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                                            <fo:block>
                                              <xsl:value-of select="//DecisionLegislationApplicable/PeriodForWhichDecisionApplies/OpenPeriod/startDate"/>
                                            </fo:block>
                                          </fo:table-cell>
                                        </fo:table-row>
                                      </fo:table-body>
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>9. Artikel der Verordnung (EG) Nr. 883/2004</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">9.1.</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
                      <xsl:value-of select="//articleRegulationECNo8832004/value"/>
                      <fo:block>
                        <xsl:choose>
                          <xsl:when test="//articleRegulationECNo8832004/value='01'">
                            <fo:block>Artikel 11 Absatz 3 Buchstabe b</fo:block>
                          </xsl:when>
                          <xsl:when test="//articleRegulationECNo8832004/value='02'">
                            <fo:block>Artikel 11 Absatz 3 Buchstabe c</fo:block>
                          </xsl:when>
                          <xsl:when test="//articleRegulationECNo8832004/value='03'">
                            <fo:block>Artikel 11 Absatz 3 Buchstabe d</fo:block>
                          </xsl:when>
                          <xsl:when test="//articleRegulationECNo8832004/value='04'">
                            <fo:block>Artikel 11 Absatz 4</fo:block>
                          </xsl:when>
                          <xsl:when test="//articleRegulationECNo8832004/value='05'">
                            <fo:block>Artikel 11 Absatz 5</fo:block>
                          </xsl:when>
                          <xsl:when test="//articleRegulationECNo8832004/value='06'">
          ...
          <fo:block>
            <fo:table table-layout="fixed" width="100%" margin="2mm 0mm 2mm 2mm" border="solid 0.2mm Grey">
              ...
              <fo:table-header background-color="LightGrey">
                <fo:table-row border="solid 0.2mm Grey">
                  <fo:table-cell number-columns-spanned="2" padding="1mm 0mm 1mm 0mm" font-weight="bold">
                    <fo:block>10. Zusätzliche Informationen</fo:block>
                  </fo:table-cell>
                </fo:table-row>
              </fo:table-header>
              <fo:table-body start-indent="2mm">
                <fo:table-row>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block wrap-option="wrap">10.1. Zusätzliche Informationen</fo:block>
                  </fo:table-cell>
                  <fo:table-cell border-top="solid 0.2mm Grey" border-bottom="solid 0.2mm Grey" padding="1mm 0mm 1mm 0mm">
                    <fo:block>
